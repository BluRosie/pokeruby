...
// Gives 4 bytes of status ailments per mon.  Currently the entire most significant byte is also free for each mon
...
#define STATUS3_AQUA_RING               0x8000000
