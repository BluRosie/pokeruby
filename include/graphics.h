...
extern const u8 gMonFrontPic_VenusaurFemale[];
...
extern const u8 gMonFrontPic_ButterfreeFemale[];
...
extern const u8 gMonFrontPic_RattataFemale[];
extern const u8 gMonFrontPic_Raticate[];
extern const u8 gMonFrontPic_RaticateFemale[];
...
extern const u8 gMonFrontPic_PikachuFemale[];
extern const u8 gMonFrontPic_Raichu[];
extern const u8 gMonFrontPic_RaichuFemale[];
...
extern const u8 gMonFrontPic_ZubatFemale[];
extern const u8 gMonFrontPic_Golbat[];
extern const u8 gMonFrontPic_GolbatFemale[];
extern const u8 gMonFrontPic_Oddish[];
extern const u8 gMonFrontPic_Gloom[];
extern const u8 gMonFrontPic_GloomFemale[];
extern const u8 gMonFrontPic_Vileplume[];
extern const u8 gMonFrontPic_VileplumeFemale[];
...
extern const u8 gMonFrontPic_KadabraFemale[];
extern const u8 gMonFrontPic_Alakazam[];
extern const u8 gMonFrontPic_AlakazamFemale[];
...
extern const u8 gMonFrontPic_DoduoFemale[];
extern const u8 gMonFrontPic_Dodrio[];
extern const u8 gMonFrontPic_DodrioFemale[];
...
extern const u8 gMonFrontPic_HypnoFemale[];
...
extern const u8 gMonFrontPic_RhyhornFemale[];
extern const u8 gMonFrontPic_Rhydon[];
extern const u8 gMonFrontPic_RhydonFemale[];
...
extern const u8 gMonFrontPic_GoldeenFemale[];
extern const u8 gMonFrontPic_Seaking[];
extern const u8 gMonFrontPic_SeakingFemale[];
...
extern const u8 gMonFrontPic_ScytherFemale[];
...
extern const u8 gMonFrontPic_MagikarpFemale[];
extern const u8 gMonFrontPic_Gyarados[];
extern const u8 gMonFrontPic_GyaradosFemale[];
...
extern const u8 gMonFrontPic_MeganiumFemale[];
...
extern const u8 gMonFrontPic_LedybaFemale[];
extern const u8 gMonFrontPic_Ledian[];
extern const u8 gMonFrontPic_LedianFemale[];
...
extern const u8 gMonFrontPic_XatuFemale[];
...
extern const u8 gMonFrontPic_SudowoodoFemale[];
extern const u8 gMonFrontPic_Politoed[];
extern const u8 gMonFrontPic_PolitoedFemale[];
...
extern const u8 gMonFrontPic_AipomFemale[];
...
extern const u8 gMonFrontPic_WobbuffetFemale[];
extern const u8 gMonFrontPic_Girafarig[];
extern const u8 gMonFrontPic_GirafarigFemale[];
...
extern const u8 gMonFrontPic_GligarFemale[];
extern const u8 gMonFrontPic_Steelix[];
extern const u8 gMonFrontPic_SteelixFemale[];
...
extern const u8 gMonFrontPic_CombuskenFemale[];
extern const u8 gMonFrontPic_Blaziken[];
extern const u8 gMonFrontPic_BlazikenFemale[];
...
extern const u8 gMonFrontPic_MiloticFemale[];
...
extern const u8 gMonFrontPic_NumelFemale[];
extern const u8 gMonFrontPic_Camerupt[];
extern const u8 gMonFrontPic_CameruptFemale[];
...
extern const u8 gMonFrontPic_CacturneFemale[];
...
extern const u8 gMonFrontPic_MedititeFemale[];
extern const u8 gMonFrontPic_Medicham[];
extern const u8 gMonFrontPic_MedichamFemale[];
...
extern const u8 gMonFrontPic_RoseliaFemale[];
...
extern const u8 gMonFrontPic_GulpinFemale[];
extern const u8 gMonFrontPic_Swalot[];
extern const u8 gMonFrontPic_SwalotFemale[];
...
extern const u8 gMonFrontPic_RelicanthFemale[];
...
extern const u8 gMonFrontPic_Grotle[];
extern const u8 gMonFrontPic_Torterra[];
extern const u8 gMonFrontPic_Chimchar[];
extern const u8 gMonFrontPic_Monferno[];
extern const u8 gMonFrontPic_Infernape[];
extern const u8 gMonFrontPic_Piplup[];
extern const u8 gMonFrontPic_Prinplup[];
extern const u8 gMonFrontPic_Empoleon[];
extern const u8 gMonFrontPic_Starly[];
extern const u8 gMonFrontPic_Staravia[];
extern const u8 gMonFrontPic_Staraptor[];
extern const u8 gMonFrontPic_Bidoof[];
extern const u8 gMonFrontPic_Bibarel[];
extern const u8 gMonFrontPic_Kricketot[];
extern const u8 gMonFrontPic_Kricketune[];
extern const u8 gMonFrontPic_Shinx[];
extern const u8 gMonFrontPic_Luxio[];
extern const u8 gMonFrontPic_Luxray[];
extern const u8 gMonFrontPic_StarlyFemale[];
extern const u8 gMonFrontPic_StaraviaFemale[];
extern const u8 gMonFrontPic_StaraptorFemale[];
extern const u8 gMonFrontPic_BidoofFemale[];
extern const u8 gMonFrontPic_BibarelFemale[];
extern const u8 gMonFrontPic_KricketotFemale[];
extern const u8 gMonFrontPic_KricketuneFemale[];
extern const u8 gMonFrontPic_ShinxFemale[];
extern const u8 gMonFrontPic_LuxioFemale[];
extern const u8 gMonFrontPic_LuxrayFemale[];
extern const u8 gMonFrontPic_Budew[];
extern const u8 gMonFrontPic_Roserade[];
extern const u8 gMonFrontPic_RoseradeFemale[];
extern const u8 gMonFrontPic_Cranidos[];
extern const u8 gMonFrontPic_Rampardos[];
extern const u8 gMonFrontPic_Shieldon[];
extern const u8 gMonFrontPic_Bastiodon[];
extern const u8 gMonFrontPic_BurmyPlant[];
extern const u8 gMonFrontPic_BurmySandy[];
extern const u8 gMonFrontPic_BurmyTrash[];
extern const u8 gMonFrontPic_WormadamPlant[];
extern const u8 gMonFrontPic_WormadamSandy[];
extern const u8 gMonFrontPic_WormadamTrash[];
extern const u8 gMonFrontPic_Mothim[];
extern const u8 gMonFrontPic_Combee[];
extern const u8 gMonFrontPic_CombeeFemale[];
extern const u8 gMonFrontPic_Vespiquen[];
extern const u8 gMonFrontPic_Pachirisu[];
extern const u8 gMonFrontPic_Buizel[];
extern const u8 gMonFrontPic_Floatzel[];
extern const u8 gMonFrontPic_PachirisuFemale[];
extern const u8 gMonFrontPic_Cherubi[];
extern const u8 gMonFrontPic_Cherrim[];
extern const u8 gMonFrontPic_ShellosE[];
extern const u8 gMonFrontPic_GastrodonE[];
extern const u8 gMonFrontPic_Ambipom[];
extern const u8 gMonFrontPic_AmbipomFemale[];
extern const u8 gMonFrontPic_Drifloon[];
extern const u8 gMonFrontPic_Drifblim[];
extern const u8 gMonFrontPic_Buneary[];
extern const u8 gMonFrontPic_Lopunny[];
extern const u8 gMonFrontPic_Mismagius[];
extern const u8 gMonFrontPic_Honchkrow[];
extern const u8 gMonFrontPic_Glameow[];
extern const u8 gMonFrontPic_Purugly[];
extern const u8 gMonFrontPic_Chingling[];
extern const u8 gMonFrontPic_Stunky[];
extern const u8 gMonFrontPic_Skuntank[];
extern const u8 gMonFrontPic_Bronzor[];
extern const u8 gMonFrontPic_Bronzong[];
extern const u8 gMonFrontPic_Bonsly[];
extern const u8 gMonFrontPic_Mimejr[];
extern const u8 gMonFrontPic_Happiny[];
extern const u8 gMonFrontPic_Chatot[];
extern const u8 gMonFrontPic_Spiritomb[];
extern const u8 gMonFrontPic_Gible[];
extern const u8 gMonFrontPic_Gabite[];
extern const u8 gMonFrontPic_Garchomp[];
extern const u8 gMonFrontPic_GibleFemale[];
extern const u8 gMonFrontPic_GabiteFemale[];
extern const u8 gMonFrontPic_GarchompFemale[];
extern const u8 gMonFrontPic_Munchlax[];
extern const u8 gMonFrontPic_Riolu[];
extern const u8 gMonFrontPic_Lucario[];
extern const u8 gMonFrontPic_Hippopotas[];
extern const u8 gMonFrontPic_Hippowdon[];
extern const u8 gMonFrontPic_HippopotasFemale[];
extern const u8 gMonFrontPic_HippowdonFemale[];
extern const u8 gMonFrontPic_Skorupi[];
extern const u8 gMonFrontPic_Drapion[];
extern const u8 gMonFrontPic_Croagunk[];
extern const u8 gMonFrontPic_Toxicroak[];
extern const u8 gMonFrontPic_CroagunkFemale[];
extern const u8 gMonFrontPic_ToxicroakFemale[];
extern const u8 gMonFrontPic_Carnivine[];
extern const u8 gMonFrontPic_Finneon[];
extern const u8 gMonFrontPic_Lumineon[];
extern const u8 gMonFrontPic_FinneonFemale[];
extern const u8 gMonFrontPic_LumineonFemale[];
extern const u8 gMonFrontPic_Mantyke[];
extern const u8 gMonFrontPic_Snover[];
extern const u8 gMonFrontPic_Abomasnow[];
extern const u8 gMonFrontPic_Weavile[];
extern const u8 gMonFrontPic_SnoverFemale[];
extern const u8 gMonFrontPic_AbomasnowFemale[];
extern const u8 gMonFrontPic_WeavileFemale[];
extern const u8 gMonFrontPic_Magnezone[];
extern const u8 gMonFrontPic_Lickilicky[];
extern const u8 gMonFrontPic_Rhyperior[];
extern const u8 gMonFrontPic_Tangrowth[];
extern const u8 gMonFrontPic_RhyperiorFemale[];
extern const u8 gMonFrontPic_TangrowthFemale[];
extern const u8 gMonFrontPic_Electivire[];
extern const u8 gMonFrontPic_Magmortar[];
extern const u8 gMonFrontPic_Togekiss[];
extern const u8 gMonFrontPic_Yanmega[];
extern const u8 gMonFrontPic_Leafeon[];
extern const u8 gMonFrontPic_Glaceon[];
extern const u8 gMonFrontPic_Gliscor[];
extern const u8 gMonFrontPic_Mamoswine[];
extern const u8 gMonFrontPic_MamoswineFemale[];
extern const u8 gMonFrontPic_PorygonZ[];
extern const u8 gMonFrontPic_Gallade[];
extern const u8 gMonFrontPic_Probopass[];
extern const u8 gMonFrontPic_Dusknoir[];
extern const u8 gMonFrontPic_Froslass[];
extern const u8 gMonFrontPic_RotomNormal[];
extern const u8 gMonFrontPic_RotomHeat[];
extern const u8 gMonFrontPic_RotomFrost[];
extern const u8 gMonFrontPic_RotomFan[];
extern const u8 gMonFrontPic_RotomMow[];
extern const u8 gMonFrontPic_RotomWash[];
extern const u8 gMonFrontPic_Uxie[];
extern const u8 gMonFrontPic_Mesprit[];
extern const u8 gMonFrontPic_Azelf[];
extern const u8 gMonFrontPic_Dialga[];
extern const u8 gMonFrontPic_Palkia[];
extern const u8 gMonFrontPic_Heatran[];
extern const u8 gMonFrontPic_Regigigas[];
extern const u8 gMonFrontPic_Giratina[];
extern const u8 gMonFrontPic_Cresselia[];
extern const u8 gMonFrontPic_Phione[];
extern const u8 gMonFrontPic_Manaphy[];
extern const u8 gMonFrontPic_Darkrai[];
extern const u8 gMonFrontPic_Shaymin[];
extern const u8 gMonFrontPic_Arceus[];

extern const u8 gMonFrontPic_Victini[];
extern const u8 gMonFrontPic_Snivy[];
extern const u8 gMonFrontPic_Servine[];
extern const u8 gMonFrontPic_Serperior[];
extern const u8 gMonFrontPic_Tepig[];
extern const u8 gMonFrontPic_Pignite[];
extern const u8 gMonFrontPic_Emboar[];
extern const u8 gMonFrontPic_Oshawott[];
extern const u8 gMonFrontPic_Dewott[];
extern const u8 gMonFrontPic_Samurott[];
extern const u8 gMonFrontPic_Patrat[];
extern const u8 gMonFrontPic_Watchog[];
extern const u8 gMonFrontPic_Lillipup[];
extern const u8 gMonFrontPic_Herdier[];
extern const u8 gMonFrontPic_Stoutland[];
extern const u8 gMonFrontPic_Purrloin[];
extern const u8 gMonFrontPic_Liepard[];
extern const u8 gMonFrontPic_Pansage[];
extern const u8 gMonFrontPic_Simisage[];
extern const u8 gMonFrontPic_Pansear[];
extern const u8 gMonFrontPic_Simisear[];
extern const u8 gMonFrontPic_Panpour[];
extern const u8 gMonFrontPic_Simipour[];
extern const u8 gMonFrontPic_Munna[];
extern const u8 gMonFrontPic_Musharna[];
extern const u8 gMonFrontPic_Pidove[];
extern const u8 gMonFrontPic_Tranquill[];
extern const u8 gMonFrontPic_Unfezant[];
extern const u8 gMonFrontPic_UnfezantFemale[];
extern const u8 gMonFrontPic_Blitzle[];
extern const u8 gMonFrontPic_Zebstrika[];
extern const u8 gMonFrontPic_Roggenrola[];
extern const u8 gMonFrontPic_Boldore[];
extern const u8 gMonFrontPic_Gigalith[];
extern const u8 gMonFrontPic_Woobat[];
extern const u8 gMonFrontPic_Swoobat[];
extern const u8 gMonFrontPic_Drilbur[];
extern const u8 gMonFrontPic_Excadrill[];
extern const u8 gMonFrontPic_Audino[];
extern const u8 gMonFrontPic_Timburr[];
extern const u8 gMonFrontPic_Gurdurr[];
extern const u8 gMonFrontPic_Conkeldurr[];
extern const u8 gMonFrontPic_Tympole[];
extern const u8 gMonFrontPic_Palpitoad[];
extern const u8 gMonFrontPic_Seismitoad[];
extern const u8 gMonFrontPic_Throh[];
extern const u8 gMonFrontPic_Sawk[];
extern const u8 gMonFrontPic_Sewaddle[];
extern const u8 gMonFrontPic_Swadloon[];
extern const u8 gMonFrontPic_Leavanny[];
extern const u8 gMonFrontPic_Venipede[];
extern const u8 gMonFrontPic_Whirlipede[];
extern const u8 gMonFrontPic_Scolipede[];
extern const u8 gMonFrontPic_Cottonee[];
extern const u8 gMonFrontPic_Whimsicott[];
extern const u8 gMonFrontPic_Petilil[];
extern const u8 gMonFrontPic_Lilligant[];
extern const u8 gMonFrontPic_Basculin[];
extern const u8 gMonFrontPic_Sandile[];
extern const u8 gMonFrontPic_Krokorok[];
extern const u8 gMonFrontPic_Krookodile[];
extern const u8 gMonFrontPic_Darumaka[];
extern const u8 gMonFrontPic_Darmanitan[];
extern const u8 gMonFrontPic_Maractus[];
extern const u8 gMonFrontPic_Dwebble[];
extern const u8 gMonFrontPic_Crustle[];
extern const u8 gMonFrontPic_Scraggy[];
extern const u8 gMonFrontPic_Scrafty[];
extern const u8 gMonFrontPic_Sigilyph[];
extern const u8 gMonFrontPic_Yamask[];
extern const u8 gMonFrontPic_Cofagrigus[];
extern const u8 gMonFrontPic_Tirtouga[];
extern const u8 gMonFrontPic_Carracosta[];
extern const u8 gMonFrontPic_Archen[];
extern const u8 gMonFrontPic_Archeops[];
extern const u8 gMonFrontPic_Trubbish[];
extern const u8 gMonFrontPic_Garbodor[];
extern const u8 gMonFrontPic_Zorua[];
extern const u8 gMonFrontPic_Zoroark[];
extern const u8 gMonFrontPic_Minccino[];
extern const u8 gMonFrontPic_Cinccino[];
extern const u8 gMonFrontPic_Gothita[];
extern const u8 gMonFrontPic_Gothorita[];
extern const u8 gMonFrontPic_Gothitelle[];
extern const u8 gMonFrontPic_Solosis[];
extern const u8 gMonFrontPic_Duosion[];
extern const u8 gMonFrontPic_Reuniclus[];
extern const u8 gMonFrontPic_Ducklett[];
extern const u8 gMonFrontPic_Swanna[];
extern const u8 gMonFrontPic_Vanillite[];
extern const u8 gMonFrontPic_Vanillish[];
extern const u8 gMonFrontPic_Vanilluxe[];
extern const u8 gMonFrontPic_Deerling[];
extern const u8 gMonFrontPic_Sawsbuck[];
extern const u8 gMonFrontPic_Emolga[];
extern const u8 gMonFrontPic_Karrablast[];
extern const u8 gMonFrontPic_Escavalier[];
extern const u8 gMonFrontPic_Foongus[];
extern const u8 gMonFrontPic_Amoonguss[];
extern const u8 gMonFrontPic_Frillish[];
extern const u8 gMonFrontPic_Jellicent[];
extern const u8 gMonFrontPic_FrillishFemale[];
extern const u8 gMonFrontPic_JellicentFemale[];
extern const u8 gMonFrontPic_Alomomola[];
extern const u8 gMonFrontPic_Joltik[];
extern const u8 gMonFrontPic_Galvantula[];
extern const u8 gMonFrontPic_Ferroseed[];
extern const u8 gMonFrontPic_Ferrothorn[];
extern const u8 gMonFrontPic_Klink[];
extern const u8 gMonFrontPic_Klang[];
extern const u8 gMonFrontPic_Klinklang[];
extern const u8 gMonFrontPic_Tynamo[];
extern const u8 gMonFrontPic_Eelektrik[];
extern const u8 gMonFrontPic_Eelektross[];
extern const u8 gMonFrontPic_Elgyem[];
extern const u8 gMonFrontPic_Beheeyem[];
extern const u8 gMonFrontPic_Litwick[];
extern const u8 gMonFrontPic_Lampent[];
extern const u8 gMonFrontPic_Chandelure[];
extern const u8 gMonFrontPic_Axew[];
extern const u8 gMonFrontPic_Fraxure[];
extern const u8 gMonFrontPic_Haxorus[];
extern const u8 gMonFrontPic_Cubchoo[];
extern const u8 gMonFrontPic_Beartic[];
extern const u8 gMonFrontPic_Cryogonal[];
extern const u8 gMonFrontPic_Shelmet[];
extern const u8 gMonFrontPic_Accelgor[];
extern const u8 gMonFrontPic_Stunfisk[];
extern const u8 gMonFrontPic_Mienfoo[];
extern const u8 gMonFrontPic_Mienshao[];
extern const u8 gMonFrontPic_Druddigon[];
extern const u8 gMonFrontPic_Golett[];
extern const u8 gMonFrontPic_Golurk[];
extern const u8 gMonFrontPic_Pawniard[];
extern const u8 gMonFrontPic_Bisharp[];
extern const u8 gMonFrontPic_Bouffalant[];
extern const u8 gMonFrontPic_Rufflet[];
extern const u8 gMonFrontPic_Braviary[];
extern const u8 gMonFrontPic_Vullaby[];
extern const u8 gMonFrontPic_Mandibuzz[];
extern const u8 gMonFrontPic_Heatmor[];
extern const u8 gMonFrontPic_Durant[];
extern const u8 gMonFrontPic_Deino[];
extern const u8 gMonFrontPic_Zweilous[];
extern const u8 gMonFrontPic_Hydreigon[];
extern const u8 gMonFrontPic_Larvesta[];
extern const u8 gMonFrontPic_Volcarona[];
extern const u8 gMonFrontPic_Cobalion[];
extern const u8 gMonFrontPic_Terrakion[];
extern const u8 gMonFrontPic_Virizion[];
extern const u8 gMonFrontPic_Tornadus[];
extern const u8 gMonFrontPic_Thundurus[];
extern const u8 gMonFrontPic_Reshiram[];
extern const u8 gMonFrontPic_Zekrom[];
extern const u8 gMonFrontPic_Landorus[];
extern const u8 gMonFrontPic_Kyurem[];
extern const u8 gMonFrontPic_Keldeo[];
extern const u8 gMonFrontPic_Meloetta[];
extern const u8 gMonFrontPic_Genesect[];
extern const u8 gMonFrontPic_Chespin[];
extern const u8 gMonFrontPic_Quilladin[];
extern const u8 gMonFrontPic_Chesnaught[];
extern const u8 gMonFrontPic_Fennekin[];
extern const u8 gMonFrontPic_Braixen[];
extern const u8 gMonFrontPic_Delphox[];
extern const u8 gMonFrontPic_Froakie[];
extern const u8 gMonFrontPic_Frogadier[];
extern const u8 gMonFrontPic_Greninja[];
extern const u8 gMonFrontPic_Bunnelby[];
extern const u8 gMonFrontPic_Diggersby[];
extern const u8 gMonFrontPic_Fletchling[];
extern const u8 gMonFrontPic_Fletchinder[];
extern const u8 gMonFrontPic_Talonflame[];
extern const u8 gMonFrontPic_Scatterbug[];
extern const u8 gMonFrontPic_Spewpa[];
extern const u8 gMonFrontPic_Vivillon[];
extern const u8 gMonFrontPic_Litleo[];
extern const u8 gMonFrontPic_Pyroar[];
extern const u8 gMonFrontPic_PyroarFemale[];
extern const u8 gMonFrontPic_Flabebe[];
extern const u8 gMonFrontPic_Floette[];
extern const u8 gMonFrontPic_Florges[];
extern const u8 gMonFrontPic_Skiddo[];
extern const u8 gMonFrontPic_Gogoat[];
extern const u8 gMonFrontPic_Pancham[];
extern const u8 gMonFrontPic_Pangoro[];
extern const u8 gMonFrontPic_Furfrou[];
extern const u8 gMonFrontPic_Espurr[];
extern const u8 gMonFrontPic_MeowsticMale[];
extern const u8 gMonFrontPic_MeowsticFemale[];
extern const u8 gMonFrontPic_Honedge[];
extern const u8 gMonFrontPic_Doublade[];
extern const u8 gMonFrontPic_Aegislash[];
extern const u8 gMonFrontPic_Spritzee[];
extern const u8 gMonFrontPic_Aromatisse[];
extern const u8 gMonFrontPic_Swirlix[];
extern const u8 gMonFrontPic_Slurpuff[];
extern const u8 gMonFrontPic_Inkay[];
extern const u8 gMonFrontPic_Malamar[];
extern const u8 gMonFrontPic_Binacle[];
extern const u8 gMonFrontPic_Barbaracle[];
extern const u8 gMonFrontPic_Skrelp[];
extern const u8 gMonFrontPic_Dragalge[];
extern const u8 gMonFrontPic_Clauncher[];
extern const u8 gMonFrontPic_Clawitzer[];
extern const u8 gMonFrontPic_Helioptile[];
extern const u8 gMonFrontPic_Heliolisk[];
extern const u8 gMonFrontPic_Tyrunt[];
extern const u8 gMonFrontPic_Tyrantrum[];
extern const u8 gMonFrontPic_Amaura[];
extern const u8 gMonFrontPic_Aurorus[];
extern const u8 gMonFrontPic_Sylveon[];
extern const u8 gMonFrontPic_Hawlucha[];
extern const u8 gMonFrontPic_Dedenne[];
extern const u8 gMonFrontPic_Carbink[];
extern const u8 gMonFrontPic_Goomy[];
extern const u8 gMonFrontPic_Sliggoo[];
extern const u8 gMonFrontPic_Goodra[];
extern const u8 gMonFrontPic_Klefki[];
extern const u8 gMonFrontPic_Phantump[];
extern const u8 gMonFrontPic_Trevenant[];
extern const u8 gMonFrontPic_Pumpkaboo[];
extern const u8 gMonFrontPic_Gourgeist[];
extern const u8 gMonFrontPic_Bergmite[];
extern const u8 gMonFrontPic_Avalugg[];
extern const u8 gMonFrontPic_Noibat[];
extern const u8 gMonFrontPic_Noivern[];
extern const u8 gMonFrontPic_Xerneas[];
extern const u8 gMonFrontPic_Yveltal[];
extern const u8 gMonFrontPic_Zygarde[];
extern const u8 gMonFrontPic_Diancie[];
extern const u8 gMonFrontPic_Hoopa[];
extern const u8 gMonFrontPic_Volcanion[];

extern const u8 gMonFrontPic_Rowlet[];
extern const u8 gMonFrontPic_Dartrix[];
extern const u8 gMonFrontPic_Decidueye[];
extern const u8 gMonFrontPic_Litten[];
extern const u8 gMonFrontPic_Torracat[];
extern const u8 gMonFrontPic_Incineroar[];
extern const u8 gMonFrontPic_Popplio[];
extern const u8 gMonFrontPic_Brionne[];
extern const u8 gMonFrontPic_Primarina[];
extern const u8 gMonFrontPic_Pikipek[];
extern const u8 gMonFrontPic_Trumbeak[];
extern const u8 gMonFrontPic_Toucannon[];
extern const u8 gMonFrontPic_Yungoos[];
extern const u8 gMonFrontPic_Gumshoos[];
extern const u8 gMonFrontPic_Grubbin[];
extern const u8 gMonFrontPic_Charjabug[];
extern const u8 gMonFrontPic_Vikavolt[];
extern const u8 gMonFrontPic_Crabrawler[];
extern const u8 gMonFrontPic_Crabominable[];
extern const u8 gMonFrontPic_Oricorio[];
extern const u8 gMonFrontPic_Cutiefly[];
extern const u8 gMonFrontPic_Ribombee[];
extern const u8 gMonFrontPic_Rockruff[];
extern const u8 gMonFrontPic_Lycanroc[];
extern const u8 gMonFrontPic_Wishiwashi[];
extern const u8 gMonFrontPic_Mareanie[];
extern const u8 gMonFrontPic_Toxapex[];
extern const u8 gMonFrontPic_Mudbray[];
extern const u8 gMonFrontPic_Mudsdale[];
extern const u8 gMonFrontPic_Dewpider[];
extern const u8 gMonFrontPic_Araquanid[];
extern const u8 gMonFrontPic_Fomantis[];
extern const u8 gMonFrontPic_Lurantis[];
extern const u8 gMonFrontPic_Morelull[];
extern const u8 gMonFrontPic_Shiinotic[];
extern const u8 gMonFrontPic_Salandit[];
extern const u8 gMonFrontPic_Salazzle[];
extern const u8 gMonFrontPic_Stufful[];
extern const u8 gMonFrontPic_Bewear[];
extern const u8 gMonFrontPic_Bounsweet[];
extern const u8 gMonFrontPic_Steenee[];
extern const u8 gMonFrontPic_Tsareena[];
extern const u8 gMonFrontPic_Comfey[];
extern const u8 gMonFrontPic_Oranguru[];
extern const u8 gMonFrontPic_Passimian[];
extern const u8 gMonFrontPic_Wimpod[];
extern const u8 gMonFrontPic_Golisopod[];
extern const u8 gMonFrontPic_Sandygast[];
extern const u8 gMonFrontPic_Palossand[];
extern const u8 gMonFrontPic_Pyukumuku[];
extern const u8 gMonFrontPic_Type_null[];
extern const u8 gMonFrontPic_Silvally[];
extern const u8 gMonFrontPic_Minior[];
extern const u8 gMonFrontPic_Komala[];
extern const u8 gMonFrontPic_Turtonator[];
extern const u8 gMonFrontPic_Togedemaru[];
extern const u8 gMonFrontPic_Mimikyu[];
extern const u8 gMonFrontPic_Bruxish[];
extern const u8 gMonFrontPic_Drampa[];
extern const u8 gMonFrontPic_Dhelmise[];
extern const u8 gMonFrontPic_Jangmo_o[];
extern const u8 gMonFrontPic_Hakamo_o[];
extern const u8 gMonFrontPic_Kommo_o[];
extern const u8 gMonFrontPic_Tapu_koko[];
extern const u8 gMonFrontPic_Tapu_lele[];
extern const u8 gMonFrontPic_Tapu_bulu[];
extern const u8 gMonFrontPic_Tapu_fini[];
extern const u8 gMonFrontPic_Cosmog[];
extern const u8 gMonFrontPic_Cosmoem[];
extern const u8 gMonFrontPic_Solgaleo[];
extern const u8 gMonFrontPic_Lunala[];
extern const u8 gMonFrontPic_Nihilego[];
extern const u8 gMonFrontPic_Buzzwole[];
extern const u8 gMonFrontPic_Pheromosa[];
extern const u8 gMonFrontPic_Xurkitree[];
extern const u8 gMonFrontPic_Celesteela[];
extern const u8 gMonFrontPic_Kartana[];
extern const u8 gMonFrontPic_Guzzlord[];
extern const u8 gMonFrontPic_Necrozma[];
extern const u8 gMonFrontPic_Magearna[];
extern const u8 gMonFrontPic_Marshadow[];
extern const u8 gMonFrontPic_Poipole[];
extern const u8 gMonFrontPic_Naganadel[];
extern const u8 gMonFrontPic_Stakataka[];
extern const u8 gMonFrontPic_Blacephalon[];
extern const u8 gMonFrontPic_Zeraora[];
...
extern const u8 gMonBackPic_VenusaurFemale[];
...
extern const u8 gMonBackPic_RattataFemale[];
extern const u8 gMonBackPic_RaticateFemale[];
...
extern const u8 gMonBackPic_PikachuFemale[];
extern const u8 gMonBackPic_RaichuFemale[];
...
extern const u8 gMonBackPic_ZubatFemale[];
extern const u8 gMonBackPic_GolbatFemale[];
extern const u8 gMonBackPic_Oddish[];
extern const u8 gMonBackPic_Gloom[];
extern const u8 gMonBackPic_Vileplume[];
extern const u8 gMonBackPic_GloomFemale[];
extern const u8 gMonBackPic_VileplumeFemale[];
...
extern const u8 gMonBackPic_KadabraFemale[];
extern const u8 gMonBackPic_AlakazamFemale[];
...
extern const u8 gMonBackPic_DoduoFemale[];
extern const u8 gMonBackPic_DodrioFemale[];
...
extern const u8 gMonBackPic_HypnoFemale[];
...
extern const u8 gMonBackPic_RhyhornFemale[];
extern const u8 gMonBackPic_RhydonFemale[];
...
extern const u8 gMonBackPic_GoldeenFemale[];
extern const u8 gMonBackPic_SeakingFemale[];
...
extern const u8 gMonBackPic_ScytherFemale[];
...
extern const u8 gMonBackPic_MagikarpFemale[];
extern const u8 gMonBackPic_GyaradosFemale[];
...
extern const u8 gMonBackPic_MeganiumFemale[];
...
extern const u8 gMonBackPic_LedybaFemale[];
extern const u8 gMonBackPic_LedianFemale[];
...
extern const u8 gMonBackPic_SudowoodoFemale[];
extern const u8 gMonBackPic_PolitoedFemale[];
...
extern const u8 gMonBackPic_AipomFemale[];
...
extern const u8 gMonBackPic_WooperFemale[];
extern const u8 gMonBackPic_QuagsireFemale[];
extern const u8 gMonBackPic_Espeon[];
extern const u8 gMonBackPic_Umbreon[];
extern const u8 gMonBackPic_Murkrow[];
extern const u8 gMonBackPic_MurkrowFemale[];
...
extern const u8 gMonBackPic_WobbuffetFemale[];
extern const u8 gMonBackPic_GirafarigFemale[];
...
extern const u8 gMonBackPic_SteelixFemale[];
...
extern const u8 gMonBackPic_HeracrossFemale[];
extern const u8 gMonBackPic_SneaselFemale[];
extern const u8 gMonBackPic_Teddiursa[];
extern const u8 gMonBackPic_Ursaring[];
extern const u8 gMonBackPic_UrsaringFemale[];
...
extern const u8 gMonBackPic_TorchicFemale[];
extern const u8 gMonBackPic_CombuskenFemale[];
extern const u8 gMonBackPic_BlazikenFemale[];
...
extern const u8 gMonBackPic_MiloticFemale[];
...
extern const u8 gMonBackPic_NumelFemale[];
extern const u8 gMonBackPic_CameruptFemale[];
...
extern const u8 gMonBackPic_MedititeFemale[];
extern const u8 gMonBackPic_MedichamFemale[];
...
extern const u8 gMonBackPic_RoseliaFemale[];
...
extern const u8 gMonBackPic_GulpinFemale[];
extern const u8 gMonBackPic_SwalotFemale[];
...
extern const u8 gMonBackPic_RelicanthFemale[];
...
extern const u8 gMonBackPic_Grotle[];
extern const u8 gMonBackPic_Torterra[];
extern const u8 gMonBackPic_Chimchar[];
extern const u8 gMonBackPic_Monferno[];
extern const u8 gMonBackPic_Infernape[];
extern const u8 gMonBackPic_Piplup[];
extern const u8 gMonBackPic_Prinplup[];
extern const u8 gMonBackPic_Empoleon[];
extern const u8 gMonBackPic_Starly[];
extern const u8 gMonBackPic_Staravia[];
extern const u8 gMonBackPic_Staraptor[];
extern const u8 gMonBackPic_Bidoof[];
extern const u8 gMonBackPic_Bibarel[];
extern const u8 gMonBackPic_Kricketot[];
extern const u8 gMonBackPic_Kricketune[];
extern const u8 gMonBackPic_Shinx[];
extern const u8 gMonBackPic_Luxio[];
extern const u8 gMonBackPic_Luxray[];
extern const u8 gMonBackPic_StarlyFemale[];
extern const u8 gMonBackPic_BidoofFemale[];
extern const u8 gMonBackPic_KricketotFemale[];
extern const u8 gMonBackPic_KricketuneFemale[];
extern const u8 gMonBackPic_ShinxFemale[];
extern const u8 gMonBackPic_LuxioFemale[];
extern const u8 gMonBackPic_LuxrayFemale[];
extern const u8 gMonBackPic_Budew[];
extern const u8 gMonBackPic_Roserade[];
extern const u8 gMonBackPic_Cranidos[];
extern const u8 gMonBackPic_Rampardos[];
extern const u8 gMonBackPic_Shieldon[];
extern const u8 gMonBackPic_Bastiodon[];
extern const u8 gMonBackPic_BurmyPlant[];
extern const u8 gMonBackPic_BurmySandy[];
extern const u8 gMonBackPic_BurmyTrash[];
extern const u8 gMonBackPic_WormadamPlant[];
extern const u8 gMonBackPic_WormadamSandy[];
extern const u8 gMonBackPic_WormadamTrash[];
extern const u8 gMonBackPic_Mothim[];
extern const u8 gMonBackPic_Combee[];
extern const u8 gMonBackPic_Vespiquen[];
extern const u8 gMonBackPic_Pachirisu[];
extern const u8 gMonBackPic_Buizel[];
extern const u8 gMonBackPic_Floatzel[];
extern const u8 gMonBackPic_PachirisuFemale[];
extern const u8 gMonBackPic_BuizelFemale[];
extern const u8 gMonBackPic_FloatzelFemale[];
extern const u8 gMonBackPic_Cherubi[];
extern const u8 gMonBackPic_Cherrim[];
extern const u8 gMonBackPic_ShellosE[];
extern const u8 gMonBackPic_GastrodonE[];
extern const u8 gMonBackPic_Ambipom[];
extern const u8 gMonBackPic_AmbipomFemale[];
extern const u8 gMonBackPic_Drifloon[];
extern const u8 gMonBackPic_Drifblim[];
extern const u8 gMonBackPic_Buneary[];
extern const u8 gMonBackPic_Lopunny[];
extern const u8 gMonBackPic_Mismagius[];
extern const u8 gMonBackPic_Honchkrow[];
extern const u8 gMonBackPic_Glameow[];
extern const u8 gMonBackPic_Purugly[];
extern const u8 gMonBackPic_Chingling[];
extern const u8 gMonBackPic_Stunky[];
extern const u8 gMonBackPic_Skuntank[];
extern const u8 gMonBackPic_Bronzor[];
extern const u8 gMonBackPic_Bronzong[];
extern const u8 gMonBackPic_Bonsly[];
extern const u8 gMonBackPic_Mimejr[];
extern const u8 gMonBackPic_Happiny[];
extern const u8 gMonBackPic_Chatot[];
extern const u8 gMonBackPic_Spiritomb[];
extern const u8 gMonBackPic_Gible[];
extern const u8 gMonBackPic_Gabite[];
extern const u8 gMonBackPic_Garchomp[];
extern const u8 gMonBackPic_GibleFemale[];
extern const u8 gMonBackPic_GabiteFemale[];
extern const u8 gMonBackPic_Munchlax[];
extern const u8 gMonBackPic_Riolu[];
extern const u8 gMonBackPic_Lucario[];
extern const u8 gMonBackPic_Hippopotas[];
extern const u8 gMonBackPic_Hippowdon[];
extern const u8 gMonBackPic_HippopotasFemale[];
extern const u8 gMonBackPic_HippowdonFemale[];
extern const u8 gMonBackPic_Skorupi[];
extern const u8 gMonBackPic_Drapion[];
extern const u8 gMonBackPic_Croagunk[];
extern const u8 gMonBackPic_Toxicroak[];
extern const u8 gMonBackPic_CroagunkFemale[];
extern const u8 gMonBackPic_ToxicroakFemale[];
extern const u8 gMonBackPic_Carnivine[];
extern const u8 gMonBackPic_Finneon[];
extern const u8 gMonBackPic_Lumineon[];
extern const u8 gMonBackPic_FinneonFemale[];
extern const u8 gMonBackPic_LumineonFemale[];
extern const u8 gMonBackPic_Mantyke[];
extern const u8 gMonBackPic_Snover[];
extern const u8 gMonBackPic_Abomasnow[];
extern const u8 gMonBackPic_Weavile[];
extern const u8 gMonBackPic_SnoverFemale[];
extern const u8 gMonBackPic_WeavileFemale[];
extern const u8 gMonBackPic_Magnezone[];
extern const u8 gMonBackPic_Lickilicky[];
extern const u8 gMonBackPic_Rhyperior[];
extern const u8 gMonBackPic_Tangrowth[];
extern const u8 gMonBackPic_RhyperiorFemale[];
extern const u8 gMonBackPic_Electivire[];
extern const u8 gMonBackPic_Magmortar[];
extern const u8 gMonBackPic_Togekiss[];
extern const u8 gMonBackPic_Yanmega[];
extern const u8 gMonBackPic_Leafeon[];
extern const u8 gMonBackPic_Glaceon[];
extern const u8 gMonBackPic_Gliscor[];
extern const u8 gMonBackPic_Mamoswine[];
extern const u8 gMonBackPic_PorygonZ[];
extern const u8 gMonBackPic_Gallade[];
extern const u8 gMonBackPic_Probopass[];
extern const u8 gMonBackPic_Dusknoir[];
extern const u8 gMonBackPic_Froslass[];
extern const u8 gMonBackPic_RotomNormal[];
extern const u8 gMonBackPic_RotomHeat[];
extern const u8 gMonBackPic_RotomFrost[];
extern const u8 gMonBackPic_RotomFan[];
extern const u8 gMonBackPic_RotomMow[];
extern const u8 gMonBackPic_RotomWash[];
extern const u8 gMonBackPic_Uxie[];
extern const u8 gMonBackPic_Mesprit[];
extern const u8 gMonBackPic_Azelf[];
extern const u8 gMonBackPic_Dialga[];
extern const u8 gMonBackPic_Palkia[];
extern const u8 gMonBackPic_Heatran[];
extern const u8 gMonBackPic_Regigigas[];
extern const u8 gMonBackPic_Giratina[];
extern const u8 gMonBackPic_Cresselia[];
extern const u8 gMonBackPic_Phione[];
extern const u8 gMonBackPic_Manaphy[];
extern const u8 gMonBackPic_Darkrai[];
extern const u8 gMonBackPic_Shaymin[];
extern const u8 gMonBackPic_Arceus[];

extern const u8 gMonBackPic_Victini[];
extern const u8 gMonBackPic_Snivy[];
extern const u8 gMonBackPic_Servine[];
extern const u8 gMonBackPic_Serperior[];
extern const u8 gMonBackPic_Tepig[];
extern const u8 gMonBackPic_Pignite[];
extern const u8 gMonBackPic_Emboar[];
extern const u8 gMonBackPic_Oshawott[];
extern const u8 gMonBackPic_Dewott[];
extern const u8 gMonBackPic_Samurott[];
extern const u8 gMonBackPic_Patrat[];
extern const u8 gMonBackPic_Watchog[];
extern const u8 gMonBackPic_Lillipup[];
extern const u8 gMonBackPic_Herdier[];
extern const u8 gMonBackPic_Stoutland[];
extern const u8 gMonBackPic_Purrloin[];
extern const u8 gMonBackPic_Liepard[];
extern const u8 gMonBackPic_Pansage[];
extern const u8 gMonBackPic_Simisage[];
extern const u8 gMonBackPic_Pansear[];
extern const u8 gMonBackPic_Simisear[];
extern const u8 gMonBackPic_Panpour[];
extern const u8 gMonBackPic_Simipour[];
extern const u8 gMonBackPic_Munna[];
extern const u8 gMonBackPic_Musharna[];
extern const u8 gMonBackPic_Pidove[];
extern const u8 gMonBackPic_Tranquill[];
extern const u8 gMonBackPic_Unfezant[];
extern const u8 gMonBackPic_UnfezantFemale[];
extern const u8 gMonBackPic_Blitzle[];
extern const u8 gMonBackPic_Zebstrika[];
extern const u8 gMonBackPic_Roggenrola[];
extern const u8 gMonBackPic_Boldore[];
extern const u8 gMonBackPic_Gigalith[];
extern const u8 gMonBackPic_Woobat[];
extern const u8 gMonBackPic_Swoobat[];
extern const u8 gMonBackPic_Drilbur[];
extern const u8 gMonBackPic_Excadrill[];
extern const u8 gMonBackPic_Audino[];
extern const u8 gMonBackPic_Timburr[];
extern const u8 gMonBackPic_Gurdurr[];
extern const u8 gMonBackPic_Conkeldurr[];
extern const u8 gMonBackPic_Tympole[];
extern const u8 gMonBackPic_Palpitoad[];
extern const u8 gMonBackPic_Seismitoad[];
extern const u8 gMonBackPic_Throh[];
extern const u8 gMonBackPic_Sawk[];
extern const u8 gMonBackPic_Sewaddle[];
extern const u8 gMonBackPic_Swadloon[];
extern const u8 gMonBackPic_Leavanny[];
extern const u8 gMonBackPic_Venipede[];
extern const u8 gMonBackPic_Whirlipede[];
extern const u8 gMonBackPic_Scolipede[];
extern const u8 gMonBackPic_Cottonee[];
extern const u8 gMonBackPic_Whimsicott[];
extern const u8 gMonBackPic_Petilil[];
extern const u8 gMonBackPic_Lilligant[];
extern const u8 gMonBackPic_Basculin[];
extern const u8 gMonBackPic_Sandile[];
extern const u8 gMonBackPic_Krokorok[];
extern const u8 gMonBackPic_Krookodile[];
extern const u8 gMonBackPic_Darumaka[];
extern const u8 gMonBackPic_Darmanitan[];
extern const u8 gMonBackPic_Maractus[];
extern const u8 gMonBackPic_Dwebble[];
extern const u8 gMonBackPic_Crustle[];
extern const u8 gMonBackPic_Scraggy[];
extern const u8 gMonBackPic_Scrafty[];
extern const u8 gMonBackPic_Sigilyph[];
extern const u8 gMonBackPic_Yamask[];
extern const u8 gMonBackPic_Cofagrigus[];
extern const u8 gMonBackPic_Tirtouga[];
extern const u8 gMonBackPic_Carracosta[];
extern const u8 gMonBackPic_Archen[];
extern const u8 gMonBackPic_Archeops[];
extern const u8 gMonBackPic_Trubbish[];
extern const u8 gMonBackPic_Garbodor[];
extern const u8 gMonBackPic_Zorua[];
extern const u8 gMonBackPic_Zoroark[];
extern const u8 gMonBackPic_Minccino[];
extern const u8 gMonBackPic_Cinccino[];
extern const u8 gMonBackPic_Gothita[];
extern const u8 gMonBackPic_Gothorita[];
extern const u8 gMonBackPic_Gothitelle[];
extern const u8 gMonBackPic_Solosis[];
extern const u8 gMonBackPic_Duosion[];
extern const u8 gMonBackPic_Reuniclus[];
extern const u8 gMonBackPic_Ducklett[];
extern const u8 gMonBackPic_Swanna[];
extern const u8 gMonBackPic_Vanillite[];
extern const u8 gMonBackPic_Vanillish[];
extern const u8 gMonBackPic_Vanilluxe[];
extern const u8 gMonBackPic_Deerling[];
extern const u8 gMonBackPic_Sawsbuck[];
extern const u8 gMonBackPic_Emolga[];
extern const u8 gMonBackPic_Karrablast[];
extern const u8 gMonBackPic_Escavalier[];
extern const u8 gMonBackPic_Foongus[];
extern const u8 gMonBackPic_Amoonguss[];
extern const u8 gMonBackPic_Frillish[];
extern const u8 gMonBackPic_Jellicent[];
extern const u8 gMonBackPic_FrillishFemale[];
extern const u8 gMonBackPic_JellicentFemale[];
extern const u8 gMonBackPic_Alomomola[];
extern const u8 gMonBackPic_Joltik[];
extern const u8 gMonBackPic_Galvantula[];
extern const u8 gMonBackPic_Ferroseed[];
extern const u8 gMonBackPic_Ferrothorn[];
extern const u8 gMonBackPic_Klink[];
extern const u8 gMonBackPic_Klang[];
extern const u8 gMonBackPic_Klinklang[];
extern const u8 gMonBackPic_Tynamo[];
extern const u8 gMonBackPic_Eelektrik[];
extern const u8 gMonBackPic_Eelektross[];
extern const u8 gMonBackPic_Elgyem[];
extern const u8 gMonBackPic_Beheeyem[];
extern const u8 gMonBackPic_Litwick[];
extern const u8 gMonBackPic_Lampent[];
extern const u8 gMonBackPic_Chandelure[];
extern const u8 gMonBackPic_Axew[];
extern const u8 gMonBackPic_Fraxure[];
extern const u8 gMonBackPic_Haxorus[];
extern const u8 gMonBackPic_Cubchoo[];
extern const u8 gMonBackPic_Beartic[];
extern const u8 gMonBackPic_Cryogonal[];
extern const u8 gMonBackPic_Shelmet[];
extern const u8 gMonBackPic_Accelgor[];
extern const u8 gMonBackPic_Stunfisk[];
extern const u8 gMonBackPic_Mienfoo[];
extern const u8 gMonBackPic_Mienshao[];
extern const u8 gMonBackPic_Druddigon[];
extern const u8 gMonBackPic_Golett[];
extern const u8 gMonBackPic_Golurk[];
extern const u8 gMonBackPic_Pawniard[];
extern const u8 gMonBackPic_Bisharp[];
extern const u8 gMonBackPic_Bouffalant[];
extern const u8 gMonBackPic_Rufflet[];
extern const u8 gMonBackPic_Braviary[];
extern const u8 gMonBackPic_Vullaby[];
extern const u8 gMonBackPic_Mandibuzz[];
extern const u8 gMonBackPic_Heatmor[];
extern const u8 gMonBackPic_Durant[];
extern const u8 gMonBackPic_Deino[];
extern const u8 gMonBackPic_Zweilous[];
extern const u8 gMonBackPic_Hydreigon[];
extern const u8 gMonBackPic_Larvesta[];
extern const u8 gMonBackPic_Volcarona[];
extern const u8 gMonBackPic_Cobalion[];
extern const u8 gMonBackPic_Terrakion[];
extern const u8 gMonBackPic_Virizion[];
extern const u8 gMonBackPic_Tornadus[];
extern const u8 gMonBackPic_Thundurus[];
extern const u8 gMonBackPic_Reshiram[];
extern const u8 gMonBackPic_Zekrom[];
extern const u8 gMonBackPic_Landorus[];
extern const u8 gMonBackPic_Kyurem[];
extern const u8 gMonBackPic_Keldeo[];
extern const u8 gMonBackPic_Meloetta[];
extern const u8 gMonBackPic_Genesect[];

extern const u8 gMonBackPic_Chespin[];
extern const u8 gMonBackPic_Quilladin[];
extern const u8 gMonBackPic_Chesnaught[];
extern const u8 gMonBackPic_Fennekin[];
extern const u8 gMonBackPic_Braixen[];
extern const u8 gMonBackPic_Delphox[];
extern const u8 gMonBackPic_Froakie[];
extern const u8 gMonBackPic_Frogadier[];
extern const u8 gMonBackPic_Greninja[];
extern const u8 gMonBackPic_Bunnelby[];
extern const u8 gMonBackPic_Diggersby[];
extern const u8 gMonBackPic_Fletchling[];
extern const u8 gMonBackPic_Fletchinder[];
extern const u8 gMonBackPic_Talonflame[];
extern const u8 gMonBackPic_Scatterbug[];
extern const u8 gMonBackPic_Spewpa[];
extern const u8 gMonBackPic_Vivillon[];
extern const u8 gMonBackPic_Litleo[];
extern const u8 gMonBackPic_Pyroar[];
extern const u8 gMonBackPic_PyroarFemale[];
extern const u8 gMonBackPic_Flabebe[];
extern const u8 gMonBackPic_Floette[];
extern const u8 gMonBackPic_Florges[];
extern const u8 gMonBackPic_Skiddo[];
extern const u8 gMonBackPic_Gogoat[];
extern const u8 gMonBackPic_Pancham[];
extern const u8 gMonBackPic_Pangoro[];
extern const u8 gMonBackPic_Furfrou[];
extern const u8 gMonBackPic_Espurr[];
extern const u8 gMonBackPic_MeowsticMale[];
extern const u8 gMonBackPic_MeowsticFemale[];
extern const u8 gMonBackPic_Honedge[];
extern const u8 gMonBackPic_Doublade[];
extern const u8 gMonBackPic_Aegislash[];
extern const u8 gMonBackPic_Spritzee[];
extern const u8 gMonBackPic_Aromatisse[];
extern const u8 gMonBackPic_Swirlix[];
extern const u8 gMonBackPic_Slurpuff[];
extern const u8 gMonBackPic_Inkay[];
extern const u8 gMonBackPic_Malamar[];
extern const u8 gMonBackPic_Binacle[];
extern const u8 gMonBackPic_Barbaracle[];
extern const u8 gMonBackPic_Skrelp[];
extern const u8 gMonBackPic_Dragalge[];
extern const u8 gMonBackPic_Clauncher[];
extern const u8 gMonBackPic_Clawitzer[];
extern const u8 gMonBackPic_Helioptile[];
extern const u8 gMonBackPic_Heliolisk[];
extern const u8 gMonBackPic_Tyrunt[];
extern const u8 gMonBackPic_Tyrantrum[];
extern const u8 gMonBackPic_Amaura[];
extern const u8 gMonBackPic_Aurorus[];
extern const u8 gMonBackPic_Sylveon[];
extern const u8 gMonBackPic_Hawlucha[];
extern const u8 gMonBackPic_Dedenne[];
extern const u8 gMonBackPic_Carbink[];
extern const u8 gMonBackPic_Goomy[];
extern const u8 gMonBackPic_Sliggoo[];
extern const u8 gMonBackPic_Goodra[];
extern const u8 gMonBackPic_Klefki[];
extern const u8 gMonBackPic_Phantump[];
extern const u8 gMonBackPic_Trevenant[];
extern const u8 gMonBackPic_Pumpkaboo[];
extern const u8 gMonBackPic_Gourgeist[];
extern const u8 gMonBackPic_Bergmite[];
extern const u8 gMonBackPic_Avalugg[];
extern const u8 gMonBackPic_Noibat[];
extern const u8 gMonBackPic_Noivern[];
extern const u8 gMonBackPic_Xerneas[];
extern const u8 gMonBackPic_Yveltal[];
extern const u8 gMonBackPic_Zygarde[];
extern const u8 gMonBackPic_Diancie[];
extern const u8 gMonBackPic_Hoopa[];
extern const u8 gMonBackPic_Volcanion[];
extern const u8 gMonBackPic_Rowlet[];
extern const u8 gMonBackPic_Dartrix[];
extern const u8 gMonBackPic_Decidueye[];
extern const u8 gMonBackPic_Litten[];
extern const u8 gMonBackPic_Torracat[];
extern const u8 gMonBackPic_Incineroar[];
extern const u8 gMonBackPic_Popplio[];
extern const u8 gMonBackPic_Brionne[];
extern const u8 gMonBackPic_Primarina[];
extern const u8 gMonBackPic_Pikipek[];
extern const u8 gMonBackPic_Trumbeak[];
extern const u8 gMonBackPic_Toucannon[];
extern const u8 gMonBackPic_Yungoos[];
extern const u8 gMonBackPic_Gumshoos[];
extern const u8 gMonBackPic_Grubbin[];
extern const u8 gMonBackPic_Charjabug[];
extern const u8 gMonBackPic_Vikavolt[];
extern const u8 gMonBackPic_Crabrawler[];
extern const u8 gMonBackPic_Crabominable[];
extern const u8 gMonBackPic_Oricorio[];
extern const u8 gMonBackPic_Cutiefly[];
extern const u8 gMonBackPic_Ribombee[];
extern const u8 gMonBackPic_Rockruff[];
extern const u8 gMonBackPic_Lycanroc[];
extern const u8 gMonBackPic_Wishiwashi[];
extern const u8 gMonBackPic_Mareanie[];
extern const u8 gMonBackPic_Toxapex[];
extern const u8 gMonBackPic_Mudbray[];
extern const u8 gMonBackPic_Mudsdale[];
extern const u8 gMonBackPic_Dewpider[];
extern const u8 gMonBackPic_Araquanid[];
extern const u8 gMonBackPic_Fomantis[];
extern const u8 gMonBackPic_Lurantis[];
extern const u8 gMonBackPic_Morelull[];
extern const u8 gMonBackPic_Shiinotic[];
extern const u8 gMonBackPic_Salandit[];
extern const u8 gMonBackPic_Salazzle[];
extern const u8 gMonBackPic_Stufful[];
extern const u8 gMonBackPic_Bewear[];
extern const u8 gMonBackPic_Bounsweet[];
extern const u8 gMonBackPic_Steenee[];
extern const u8 gMonBackPic_Tsareena[];
extern const u8 gMonBackPic_Comfey[];
extern const u8 gMonBackPic_Oranguru[];
extern const u8 gMonBackPic_Passimian[];
extern const u8 gMonBackPic_Wimpod[];
extern const u8 gMonBackPic_Golisopod[];
extern const u8 gMonBackPic_Sandygast[];
extern const u8 gMonBackPic_Palossand[];
extern const u8 gMonBackPic_Pyukumuku[];
extern const u8 gMonBackPic_Type_null[];
extern const u8 gMonBackPic_Silvally[];
extern const u8 gMonBackPic_Minior[];
extern const u8 gMonBackPic_Komala[];
extern const u8 gMonBackPic_Turtonator[];
extern const u8 gMonBackPic_Togedemaru[];
extern const u8 gMonBackPic_Mimikyu[];
extern const u8 gMonBackPic_Bruxish[];
extern const u8 gMonBackPic_Drampa[];
extern const u8 gMonBackPic_Dhelmise[];
extern const u8 gMonBackPic_Jangmo_o[];
extern const u8 gMonBackPic_Hakamo_o[];
extern const u8 gMonBackPic_Kommo_o[];
extern const u8 gMonBackPic_Tapu_koko[];
extern const u8 gMonBackPic_Tapu_lele[];
extern const u8 gMonBackPic_Tapu_bulu[];
extern const u8 gMonBackPic_Tapu_fini[];
extern const u8 gMonBackPic_Cosmog[];
extern const u8 gMonBackPic_Cosmoem[];
extern const u8 gMonBackPic_Solgaleo[];
extern const u8 gMonBackPic_Lunala[];
extern const u8 gMonBackPic_Nihilego[];
extern const u8 gMonBackPic_Buzzwole[];
extern const u8 gMonBackPic_Pheromosa[];
extern const u8 gMonBackPic_Xurkitree[];
extern const u8 gMonBackPic_Celesteela[];
extern const u8 gMonBackPic_Kartana[];
extern const u8 gMonBackPic_Guzzlord[];
extern const u8 gMonBackPic_Necrozma[];
extern const u8 gMonBackPic_Magearna[];
extern const u8 gMonBackPic_Marshadow[];
extern const u8 gMonBackPic_Poipole[];
extern const u8 gMonBackPic_Naganadel[];
extern const u8 gMonBackPic_Stakataka[];
extern const u8 gMonBackPic_Blacephalon[];
extern const u8 gMonBackPic_Zeraora[];
...
extern const u8 gMonPalette_Grotle[];
extern const u8 gMonPalette_Torterra[];
extern const u8 gMonPalette_Chimchar[];
extern const u8 gMonPalette_Monferno[];
extern const u8 gMonPalette_Infernape[];
extern const u8 gMonPalette_Piplup[];
extern const u8 gMonPalette_Prinplup[];
extern const u8 gMonPalette_Empoleon[];
extern const u8 gMonPalette_Starly[];
extern const u8 gMonPalette_Staravia[];
extern const u8 gMonPalette_Staraptor[];
extern const u8 gMonPalette_Bidoof[];
extern const u8 gMonPalette_Bibarel[];
extern const u8 gMonPalette_Kricketot[];
extern const u8 gMonPalette_Kricketune[];
extern const u8 gMonPalette_Shinx[];
extern const u8 gMonPalette_Luxio[];
extern const u8 gMonPalette_Luxray[];
extern const u8 gMonPalette_Budew[];
extern const u8 gMonPalette_Roserade[];
extern const u8 gMonPalette_Cranidos[];
extern const u8 gMonPalette_Rampardos[];
extern const u8 gMonPalette_Shieldon[];
extern const u8 gMonPalette_Bastiodon[];
extern const u8 gMonPalette_BurmyPlant[];
extern const u8 gMonPalette_BurmySandy[];
extern const u8 gMonPalette_BurmyTrash[];
extern const u8 gMonPalette_WormadamPlant[];
extern const u8 gMonPalette_WormadamSandy[];
extern const u8 gMonPalette_WormadamTrash[];
extern const u8 gMonPalette_Mothim[];
extern const u8 gMonPalette_Combee[];
extern const u8 gMonPalette_Vespiquen[];
extern const u8 gMonPalette_Pachirisu[];
extern const u8 gMonPalette_Buizel[];
extern const u8 gMonPalette_Floatzel[];
extern const u8 gMonPalette_Cherubi[];
extern const u8 gMonPalette_Cherrim[];
extern const u8 gMonPalette_ShellosE[];
extern const u8 gMonPalette_GastrodonE[];
extern const u8 gMonPalette_Ambipom[];
extern const u8 gMonPalette_Drifloon[];
extern const u8 gMonPalette_Drifblim[];
extern const u8 gMonPalette_Buneary[];
extern const u8 gMonPalette_Lopunny[];
extern const u8 gMonPalette_Mismagius[];
extern const u8 gMonPalette_Honchkrow[];
extern const u8 gMonPalette_Glameow[];
extern const u8 gMonPalette_Purugly[];
extern const u8 gMonPalette_Chingling[];
extern const u8 gMonPalette_Stunky[];
extern const u8 gMonPalette_Skuntank[];
extern const u8 gMonPalette_Bronzor[];
extern const u8 gMonPalette_Bronzong[];
extern const u8 gMonPalette_Bonsly[];
extern const u8 gMonPalette_Mimejr[];
extern const u8 gMonPalette_Happiny[];
extern const u8 gMonPalette_Chatot[];
extern const u8 gMonPalette_Spiritomb[];
extern const u8 gMonPalette_Gible[];
extern const u8 gMonPalette_Gabite[];
extern const u8 gMonPalette_Garchomp[];
extern const u8 gMonPalette_Munchlax[];
extern const u8 gMonPalette_Riolu[];
extern const u8 gMonPalette_Lucario[];
extern const u8 gMonPalette_Hippopotas[];
extern const u8 gMonPalette_Hippowdon[];
extern const u8 gMonPalette_Skorupi[];
extern const u8 gMonPalette_Drapion[];
extern const u8 gMonPalette_Croagunk[];
extern const u8 gMonPalette_Toxicroak[];
extern const u8 gMonPalette_Carnivine[];
extern const u8 gMonPalette_Finneon[];
extern const u8 gMonPalette_Lumineon[];
extern const u8 gMonPalette_Mantyke[];
extern const u8 gMonPalette_Snover[];
extern const u8 gMonPalette_Abomasnow[];
extern const u8 gMonPalette_Weavile[];
extern const u8 gMonPalette_Magnezone[];
extern const u8 gMonPalette_Lickilicky[];
extern const u8 gMonPalette_Rhyperior[];
extern const u8 gMonPalette_Tangrowth[];
extern const u8 gMonPalette_Electivire[];
extern const u8 gMonPalette_Magmortar[];
extern const u8 gMonPalette_Togekiss[];
extern const u8 gMonPalette_Yanmega[];
extern const u8 gMonPalette_Leafeon[];
extern const u8 gMonPalette_Glaceon[];
extern const u8 gMonPalette_Gliscor[];
extern const u8 gMonPalette_Mamoswine[];
extern const u8 gMonPalette_PorygonZ[];
extern const u8 gMonPalette_Gallade[];
extern const u8 gMonPalette_Probopass[];
extern const u8 gMonPalette_Dusknoir[];
extern const u8 gMonPalette_Froslass[];
extern const u8 gMonPalette_RotomNormal[];
extern const u8 gMonPalette_RotomHeat[];
extern const u8 gMonPalette_RotomFrost[];
extern const u8 gMonPalette_RotomFan[];
extern const u8 gMonPalette_RotomMow[];
extern const u8 gMonPalette_RotomWash[];
extern const u8 gMonPalette_Uxie[];
extern const u8 gMonPalette_Mesprit[];
extern const u8 gMonPalette_Azelf[];
extern const u8 gMonPalette_Dialga[];
extern const u8 gMonPalette_Palkia[];
extern const u8 gMonPalette_Heatran[];
extern const u8 gMonPalette_Regigigas[];
extern const u8 gMonPalette_Giratina[];
extern const u8 gMonPalette_Cresselia[];
extern const u8 gMonPalette_Phione[];
extern const u8 gMonPalette_Manaphy[];
extern const u8 gMonPalette_Darkrai[];
extern const u8 gMonPalette_Shaymin[];
extern const u8 gMonPalette_Arceus[];
extern const u8 gMonPalette_Victini[];
extern const u8 gMonPalette_Snivy[];
extern const u8 gMonPalette_Servine[];
extern const u8 gMonPalette_Serperior[];
extern const u8 gMonPalette_Tepig[];
extern const u8 gMonPalette_Pignite[];
extern const u8 gMonPalette_Emboar[];
extern const u8 gMonPalette_Oshawott[];
extern const u8 gMonPalette_Dewott[];
extern const u8 gMonPalette_Samurott[];
extern const u8 gMonPalette_Patrat[];
extern const u8 gMonPalette_Watchog[];
extern const u8 gMonPalette_Lillipup[];
extern const u8 gMonPalette_Herdier[];
extern const u8 gMonPalette_Stoutland[];
extern const u8 gMonPalette_Purrloin[];
extern const u8 gMonPalette_Liepard[];
extern const u8 gMonPalette_Pansage[];
extern const u8 gMonPalette_Simisage[];
extern const u8 gMonPalette_Pansear[];
extern const u8 gMonPalette_Simisear[];
extern const u8 gMonPalette_Panpour[];
extern const u8 gMonPalette_Simipour[];
extern const u8 gMonPalette_Munna[];
extern const u8 gMonPalette_Musharna[];
extern const u8 gMonPalette_Pidove[];
extern const u8 gMonPalette_Tranquill[];
extern const u8 gMonPalette_Unfezant[];
extern const u8 gMonPalette_Blitzle[];
extern const u8 gMonPalette_Zebstrika[];
extern const u8 gMonPalette_Roggenrola[];
extern const u8 gMonPalette_Boldore[];
extern const u8 gMonPalette_Gigalith[];
extern const u8 gMonPalette_Woobat[];
extern const u8 gMonPalette_Swoobat[];
extern const u8 gMonPalette_Drilbur[];
extern const u8 gMonPalette_Excadrill[];
extern const u8 gMonPalette_Audino[];
extern const u8 gMonPalette_Timburr[];
extern const u8 gMonPalette_Gurdurr[];
extern const u8 gMonPalette_Conkeldurr[];
extern const u8 gMonPalette_Tympole[];
extern const u8 gMonPalette_Palpitoad[];
extern const u8 gMonPalette_Seismitoad[];
extern const u8 gMonPalette_Throh[];
extern const u8 gMonPalette_Sawk[];
extern const u8 gMonPalette_Sewaddle[];
extern const u8 gMonPalette_Swadloon[];
extern const u8 gMonPalette_Leavanny[];
extern const u8 gMonPalette_Venipede[];
extern const u8 gMonPalette_Whirlipede[];
extern const u8 gMonPalette_Scolipede[];
extern const u8 gMonPalette_Cottonee[];
extern const u8 gMonPalette_Whimsicott[];
extern const u8 gMonPalette_Petilil[];
extern const u8 gMonPalette_Lilligant[];
extern const u8 gMonPalette_Basculin[];
extern const u8 gMonPalette_Sandile[];
extern const u8 gMonPalette_Krokorok[];
extern const u8 gMonPalette_Krookodile[];
extern const u8 gMonPalette_Darumaka[];
extern const u8 gMonPalette_Darmanitan[];
extern const u8 gMonPalette_Maractus[];
extern const u8 gMonPalette_Dwebble[];
extern const u8 gMonPalette_Crustle[];
extern const u8 gMonPalette_Scraggy[];
extern const u8 gMonPalette_Scrafty[];
extern const u8 gMonPalette_Sigilyph[];
extern const u8 gMonPalette_Yamask[];
extern const u8 gMonPalette_Cofagrigus[];
extern const u8 gMonPalette_Tirtouga[];
extern const u8 gMonPalette_Carracosta[];
extern const u8 gMonPalette_Archen[];
extern const u8 gMonPalette_Archeops[];
extern const u8 gMonPalette_Trubbish[];
extern const u8 gMonPalette_Garbodor[];
extern const u8 gMonPalette_Zorua[];
extern const u8 gMonPalette_Zoroark[];
extern const u8 gMonPalette_Minccino[];
extern const u8 gMonPalette_Cinccino[];
extern const u8 gMonPalette_Gothita[];
extern const u8 gMonPalette_Gothorita[];
extern const u8 gMonPalette_Gothitelle[];
extern const u8 gMonPalette_Solosis[];
extern const u8 gMonPalette_Duosion[];
extern const u8 gMonPalette_Reuniclus[];
extern const u8 gMonPalette_Ducklett[];
extern const u8 gMonPalette_Swanna[];
extern const u8 gMonPalette_Vanillite[];
extern const u8 gMonPalette_Vanillish[];
extern const u8 gMonPalette_Vanilluxe[];
extern const u8 gMonPalette_Deerling[];
extern const u8 gMonPalette_Sawsbuck[];
extern const u8 gMonPalette_Emolga[];
extern const u8 gMonPalette_Karrablast[];
extern const u8 gMonPalette_Escavalier[];
extern const u8 gMonPalette_Foongus[];
extern const u8 gMonPalette_Amoonguss[];
extern const u8 gMonPalette_Frillish[];
extern const u8 gMonPalette_Jellicent[];
extern const u8 gMonPalette_Alomomola[];
extern const u8 gMonPalette_Joltik[];
extern const u8 gMonPalette_Galvantula[];
extern const u8 gMonPalette_Ferroseed[];
extern const u8 gMonPalette_Ferrothorn[];
extern const u8 gMonPalette_Klink[];
extern const u8 gMonPalette_Klang[];
extern const u8 gMonPalette_Klinklang[];
extern const u8 gMonPalette_Tynamo[];
extern const u8 gMonPalette_Eelektrik[];
extern const u8 gMonPalette_Eelektross[];
extern const u8 gMonPalette_Elgyem[];
extern const u8 gMonPalette_Beheeyem[];
extern const u8 gMonPalette_Litwick[];
extern const u8 gMonPalette_Lampent[];
extern const u8 gMonPalette_Chandelure[];
extern const u8 gMonPalette_Axew[];
extern const u8 gMonPalette_Fraxure[];
extern const u8 gMonPalette_Haxorus[];
extern const u8 gMonPalette_Cubchoo[];
extern const u8 gMonPalette_Beartic[];
extern const u8 gMonPalette_Cryogonal[];
extern const u8 gMonPalette_Shelmet[];
extern const u8 gMonPalette_Accelgor[];
extern const u8 gMonPalette_Stunfisk[];
extern const u8 gMonPalette_Mienfoo[];
extern const u8 gMonPalette_Mienshao[];
extern const u8 gMonPalette_Druddigon[];
extern const u8 gMonPalette_Golett[];
extern const u8 gMonPalette_Golurk[];
extern const u8 gMonPalette_Pawniard[];
extern const u8 gMonPalette_Bisharp[];
extern const u8 gMonPalette_Bouffalant[];
extern const u8 gMonPalette_Rufflet[];
extern const u8 gMonPalette_Braviary[];
extern const u8 gMonPalette_Vullaby[];
extern const u8 gMonPalette_Mandibuzz[];
extern const u8 gMonPalette_Heatmor[];
extern const u8 gMonPalette_Durant[];
extern const u8 gMonPalette_Deino[];
extern const u8 gMonPalette_Zweilous[];
extern const u8 gMonPalette_Hydreigon[];
extern const u8 gMonPalette_Larvesta[];
extern const u8 gMonPalette_Volcarona[];
extern const u8 gMonPalette_Cobalion[];
extern const u8 gMonPalette_Terrakion[];
extern const u8 gMonPalette_Virizion[];
extern const u8 gMonPalette_Tornadus[];
extern const u8 gMonPalette_Thundurus[];
extern const u8 gMonPalette_Reshiram[];
extern const u8 gMonPalette_Zekrom[];
extern const u8 gMonPalette_Landorus[];
extern const u8 gMonPalette_Kyurem[];
extern const u8 gMonPalette_Keldeo[];
extern const u8 gMonPalette_Meloetta[];
extern const u8 gMonPalette_Genesect[];
extern const u8 gMonPalette_Chespin[];
extern const u8 gMonPalette_Quilladin[];
extern const u8 gMonPalette_Chesnaught[];
extern const u8 gMonPalette_Fennekin[];
extern const u8 gMonPalette_Braixen[];
extern const u8 gMonPalette_Delphox[];
extern const u8 gMonPalette_Froakie[];
extern const u8 gMonPalette_Frogadier[];
extern const u8 gMonPalette_Greninja[];
extern const u8 gMonPalette_Bunnelby[];
extern const u8 gMonPalette_Diggersby[];
extern const u8 gMonPalette_Fletchling[];
extern const u8 gMonPalette_Fletchinder[];
extern const u8 gMonPalette_Talonflame[];
extern const u8 gMonPalette_Scatterbug[];
extern const u8 gMonPalette_Spewpa[];
extern const u8 gMonPalette_Vivillon[];
extern const u8 gMonPalette_Litleo[];
extern const u8 gMonPalette_Pyroar[];
extern const u8 gMonPalette_Flabebe[];
extern const u8 gMonPalette_Floette[];
extern const u8 gMonPalette_Florges[];
extern const u8 gMonPalette_Skiddo[];
extern const u8 gMonPalette_Gogoat[];
extern const u8 gMonPalette_Pancham[];
extern const u8 gMonPalette_Pangoro[];
extern const u8 gMonPalette_Furfrou[];
extern const u8 gMonPalette_Espurr[];
extern const u8 gMonPalette_MeowsticMale[];
extern const u8 gMonPalette_MeowsticFemale[];
extern const u8 gMonPalette_Honedge[];
extern const u8 gMonPalette_Doublade[];
extern const u8 gMonPalette_Aegislash[];
extern const u8 gMonPalette_Spritzee[];
extern const u8 gMonPalette_Aromatisse[];
extern const u8 gMonPalette_Swirlix[];
extern const u8 gMonPalette_Slurpuff[];
extern const u8 gMonPalette_Inkay[];
extern const u8 gMonPalette_Malamar[];
extern const u8 gMonPalette_Binacle[];
extern const u8 gMonPalette_Barbaracle[];
extern const u8 gMonPalette_Skrelp[];
extern const u8 gMonPalette_Dragalge[];
extern const u8 gMonPalette_Clauncher[];
extern const u8 gMonPalette_Clawitzer[];
extern const u8 gMonPalette_Helioptile[];
extern const u8 gMonPalette_Heliolisk[];
extern const u8 gMonPalette_Tyrunt[];
extern const u8 gMonPalette_Tyrantrum[];
extern const u8 gMonPalette_Amaura[];
extern const u8 gMonPalette_Aurorus[];
extern const u8 gMonPalette_Sylveon[];
extern const u8 gMonPalette_Hawlucha[];
extern const u8 gMonPalette_Dedenne[];
extern const u8 gMonPalette_Carbink[];
extern const u8 gMonPalette_Goomy[];
extern const u8 gMonPalette_Sliggoo[];
extern const u8 gMonPalette_Goodra[];
extern const u8 gMonPalette_Klefki[];
extern const u8 gMonPalette_Phantump[];
extern const u8 gMonPalette_Trevenant[];
extern const u8 gMonPalette_Pumpkaboo[];
extern const u8 gMonPalette_Gourgeist[];
extern const u8 gMonPalette_Bergmite[];
extern const u8 gMonPalette_Avalugg[];
extern const u8 gMonPalette_Noibat[];
extern const u8 gMonPalette_Noivern[];
extern const u8 gMonPalette_Xerneas[];
extern const u8 gMonPalette_Yveltal[];
extern const u8 gMonPalette_Zygarde[];
extern const u8 gMonPalette_Diancie[];
extern const u8 gMonPalette_Hoopa[];
extern const u8 gMonPalette_Volcanion[];
extern const u8 gMonPalette_Rowlet[];
extern const u8 gMonPalette_Dartrix[];
extern const u8 gMonPalette_Decidueye[];
extern const u8 gMonPalette_Litten[];
extern const u8 gMonPalette_Torracat[];
extern const u8 gMonPalette_Incineroar[];
extern const u8 gMonPalette_Popplio[];
extern const u8 gMonPalette_Brionne[];
extern const u8 gMonPalette_Primarina[];
extern const u8 gMonPalette_Pikipek[];
extern const u8 gMonPalette_Trumbeak[];
extern const u8 gMonPalette_Toucannon[];
extern const u8 gMonPalette_Yungoos[];
extern const u8 gMonPalette_Gumshoos[];
extern const u8 gMonPalette_Grubbin[];
extern const u8 gMonPalette_Charjabug[];
extern const u8 gMonPalette_Vikavolt[];
extern const u8 gMonPalette_Crabrawler[];
extern const u8 gMonPalette_Crabominable[];
extern const u8 gMonPalette_Oricorio[];
extern const u8 gMonPalette_Cutiefly[];
extern const u8 gMonPalette_Ribombee[];
extern const u8 gMonPalette_Rockruff[];
extern const u8 gMonPalette_Lycanroc[];
extern const u8 gMonPalette_Wishiwashi[];
extern const u8 gMonPalette_Mareanie[];
extern const u8 gMonPalette_Toxapex[];
extern const u8 gMonPalette_Mudbray[];
extern const u8 gMonPalette_Mudsdale[];
extern const u8 gMonPalette_Dewpider[];
extern const u8 gMonPalette_Araquanid[];
extern const u8 gMonPalette_Fomantis[];
extern const u8 gMonPalette_Lurantis[];
extern const u8 gMonPalette_Morelull[];
extern const u8 gMonPalette_Shiinotic[];
extern const u8 gMonPalette_Salandit[];
extern const u8 gMonPalette_Salazzle[];
extern const u8 gMonPalette_Stufful[];
extern const u8 gMonPalette_Bewear[];
extern const u8 gMonPalette_Bounsweet[];
extern const u8 gMonPalette_Steenee[];
extern const u8 gMonPalette_Tsareena[];
extern const u8 gMonPalette_Comfey[];
extern const u8 gMonPalette_Oranguru[];
extern const u8 gMonPalette_Passimian[];
extern const u8 gMonPalette_Wimpod[];
extern const u8 gMonPalette_Golisopod[];
extern const u8 gMonPalette_Sandygast[];
extern const u8 gMonPalette_Palossand[];
extern const u8 gMonPalette_Pyukumuku[];
extern const u8 gMonPalette_Type_null[];
extern const u8 gMonPalette_Silvally[];
extern const u8 gMonPalette_Minior[];
extern const u8 gMonPalette_Komala[];
extern const u8 gMonPalette_Turtonator[];
extern const u8 gMonPalette_Togedemaru[];
extern const u8 gMonPalette_Mimikyu[];
extern const u8 gMonPalette_Bruxish[];
extern const u8 gMonPalette_Drampa[];
extern const u8 gMonPalette_Dhelmise[];
extern const u8 gMonPalette_Jangmo_o[];
extern const u8 gMonPalette_Hakamo_o[];
extern const u8 gMonPalette_Kommo_o[];
extern const u8 gMonPalette_Tapu_koko[];
extern const u8 gMonPalette_Tapu_lele[];
extern const u8 gMonPalette_Tapu_bulu[];
extern const u8 gMonPalette_Tapu_fini[];
extern const u8 gMonPalette_Cosmog[];
extern const u8 gMonPalette_Cosmoem[];
extern const u8 gMonPalette_Solgaleo[];
extern const u8 gMonPalette_Lunala[];
extern const u8 gMonPalette_Nihilego[];
extern const u8 gMonPalette_Buzzwole[];
extern const u8 gMonPalette_Pheromosa[];
extern const u8 gMonPalette_Xurkitree[];
extern const u8 gMonPalette_Celesteela[];
extern const u8 gMonPalette_Kartana[];
extern const u8 gMonPalette_Guzzlord[];
extern const u8 gMonPalette_Necrozma[];
extern const u8 gMonPalette_Magearna[];
extern const u8 gMonPalette_Marshadow[];
extern const u8 gMonPalette_Poipole[];
extern const u8 gMonPalette_Naganadel[];
extern const u8 gMonPalette_Stakataka[];
extern const u8 gMonPalette_Blacephalon[];
extern const u8 gMonPalette_Zeraora[];
...
extern const u8 gMonShinyPalette_Turtwig[];
extern const u8 gMonShinyPalette_Grotle[];
extern const u8 gMonShinyPalette_Torterra[];
extern const u8 gMonShinyPalette_Chimchar[];
extern const u8 gMonShinyPalette_Monferno[];
extern const u8 gMonShinyPalette_Infernape[];
extern const u8 gMonShinyPalette_Piplup[];
extern const u8 gMonShinyPalette_Prinplup[];
extern const u8 gMonShinyPalette_Empoleon[];
extern const u8 gMonShinyPalette_Starly[];
extern const u8 gMonShinyPalette_Staravia[];
extern const u8 gMonShinyPalette_Staraptor[];
extern const u8 gMonShinyPalette_Bidoof[];
extern const u8 gMonShinyPalette_Bibarel[];
extern const u8 gMonShinyPalette_Kricketot[];
extern const u8 gMonShinyPalette_Kricketune[];
extern const u8 gMonShinyPalette_Shinx[];
extern const u8 gMonShinyPalette_Luxio[];
extern const u8 gMonShinyPalette_Luxray[];
extern const u8 gMonShinyPalette_Budew[];
extern const u8 gMonShinyPalette_Roserade[];
extern const u8 gMonShinyPalette_Cranidos[];
extern const u8 gMonShinyPalette_Rampardos[];
extern const u8 gMonShinyPalette_Shieldon[];
extern const u8 gMonShinyPalette_Bastiodon[];
extern const u8 gMonShinyPalette_BurmyPlant[];
extern const u8 gMonShinyPalette_BurmySandy[];
extern const u8 gMonShinyPalette_BurmyTrash[];
extern const u8 gMonShinyPalette_WormadamPlant[];
extern const u8 gMonShinyPalette_WormadamSandy[];
extern const u8 gMonShinyPalette_WormadamTrash[];
extern const u8 gMonShinyPalette_Mothim[];
extern const u8 gMonShinyPalette_Combee[];
extern const u8 gMonShinyPalette_Vespiquen[];
extern const u8 gMonShinyPalette_Pachirisu[];
extern const u8 gMonShinyPalette_Buizel[];
extern const u8 gMonShinyPalette_Floatzel[];
extern const u8 gMonShinyPalette_Cherubi[];
extern const u8 gMonShinyPalette_Cherrim[];
extern const u8 gMonShinyPalette_ShellosE[];
extern const u8 gMonShinyPalette_GastrodonE[];
extern const u8 gMonShinyPalette_Ambipom[];
extern const u8 gMonShinyPalette_Drifloon[];
extern const u8 gMonShinyPalette_Drifblim[];
extern const u8 gMonShinyPalette_Buneary[];
extern const u8 gMonShinyPalette_Lopunny[];
extern const u8 gMonShinyPalette_Mismagius[];
extern const u8 gMonShinyPalette_Honchkrow[];
extern const u8 gMonShinyPalette_Glameow[];
extern const u8 gMonShinyPalette_Purugly[];
extern const u8 gMonShinyPalette_Chingling[];
extern const u8 gMonShinyPalette_Stunky[];
extern const u8 gMonShinyPalette_Skuntank[];
extern const u8 gMonShinyPalette_Bronzor[];
extern const u8 gMonShinyPalette_Bronzong[];
extern const u8 gMonShinyPalette_Bonsly[];
extern const u8 gMonShinyPalette_Mimejr[];
extern const u8 gMonShinyPalette_Happiny[];
extern const u8 gMonShinyPalette_Chatot[];
extern const u8 gMonShinyPalette_Spiritomb[];
extern const u8 gMonShinyPalette_Gible[];
extern const u8 gMonShinyPalette_Gabite[];
extern const u8 gMonShinyPalette_Garchomp[];
extern const u8 gMonShinyPalette_Munchlax[];
extern const u8 gMonShinyPalette_Riolu[];
extern const u8 gMonShinyPalette_Lucario[];
extern const u8 gMonShinyPalette_Hippopotas[];
extern const u8 gMonShinyPalette_Hippowdon[];
extern const u8 gMonShinyPalette_Skorupi[];
extern const u8 gMonShinyPalette_Drapion[];
extern const u8 gMonShinyPalette_Croagunk[];
extern const u8 gMonShinyPalette_Toxicroak[];
extern const u8 gMonShinyPalette_Carnivine[];
extern const u8 gMonShinyPalette_Finneon[];
extern const u8 gMonShinyPalette_Lumineon[];
extern const u8 gMonShinyPalette_Mantyke[];
extern const u8 gMonShinyPalette_Snover[];
extern const u8 gMonShinyPalette_Abomasnow[];
extern const u8 gMonShinyPalette_Weavile[];
extern const u8 gMonShinyPalette_Magnezone[];
extern const u8 gMonShinyPalette_Lickilicky[];
extern const u8 gMonShinyPalette_Rhyperior[];
extern const u8 gMonShinyPalette_Tangrowth[];
extern const u8 gMonShinyPalette_Electivire[];
extern const u8 gMonShinyPalette_Magmortar[];
extern const u8 gMonShinyPalette_Togekiss[];
extern const u8 gMonShinyPalette_Yanmega[];
extern const u8 gMonShinyPalette_Leafeon[];
extern const u8 gMonShinyPalette_Glaceon[];
extern const u8 gMonShinyPalette_Gliscor[];
extern const u8 gMonShinyPalette_Mamoswine[];
extern const u8 gMonShinyPalette_PorygonZ[];
extern const u8 gMonShinyPalette_Gallade[];
extern const u8 gMonShinyPalette_Probopass[];
extern const u8 gMonShinyPalette_Dusknoir[];
extern const u8 gMonShinyPalette_Froslass[];
extern const u8 gMonShinyPalette_RotomNormal[];
extern const u8 gMonShinyPalette_RotomHeat[];
extern const u8 gMonShinyPalette_RotomFrost[];
extern const u8 gMonShinyPalette_RotomFan[];
extern const u8 gMonShinyPalette_RotomMow[];
extern const u8 gMonShinyPalette_RotomWash[];
extern const u8 gMonShinyPalette_Uxie[];
extern const u8 gMonShinyPalette_Mesprit[];
extern const u8 gMonShinyPalette_Azelf[];
extern const u8 gMonShinyPalette_Dialga[];
extern const u8 gMonShinyPalette_Palkia[];
extern const u8 gMonShinyPalette_Heatran[];
extern const u8 gMonShinyPalette_Regigigas[];
extern const u8 gMonShinyPalette_Giratina[];
extern const u8 gMonShinyPalette_Cresselia[];
extern const u8 gMonShinyPalette_Phione[];
extern const u8 gMonShinyPalette_Manaphy[];
extern const u8 gMonShinyPalette_Darkrai[];
extern const u8 gMonShinyPalette_Shaymin[];
extern const u8 gMonShinyPalette_Arceus[];
extern const u8 gMonShinyPalette_Victini[];
extern const u8 gMonShinyPalette_Snivy[];
extern const u8 gMonShinyPalette_Servine[];
extern const u8 gMonShinyPalette_Serperior[];
extern const u8 gMonShinyPalette_Tepig[];
extern const u8 gMonShinyPalette_Pignite[];
extern const u8 gMonShinyPalette_Emboar[];
extern const u8 gMonShinyPalette_Oshawott[];
extern const u8 gMonShinyPalette_Dewott[];
extern const u8 gMonShinyPalette_Samurott[];
extern const u8 gMonShinyPalette_Patrat[];
extern const u8 gMonShinyPalette_Watchog[];
extern const u8 gMonShinyPalette_Lillipup[];
extern const u8 gMonShinyPalette_Herdier[];
extern const u8 gMonShinyPalette_Stoutland[];
extern const u8 gMonShinyPalette_Purrloin[];
extern const u8 gMonShinyPalette_Liepard[];
extern const u8 gMonShinyPalette_Pansage[];
extern const u8 gMonShinyPalette_Simisage[];
extern const u8 gMonShinyPalette_Pansear[];
extern const u8 gMonShinyPalette_Simisear[];
extern const u8 gMonShinyPalette_Panpour[];
extern const u8 gMonShinyPalette_Simipour[];
extern const u8 gMonShinyPalette_Munna[];
extern const u8 gMonShinyPalette_Musharna[];
extern const u8 gMonShinyPalette_Pidove[];
extern const u8 gMonShinyPalette_Tranquill[];
extern const u8 gMonShinyPalette_Unfezant[];
extern const u8 gMonShinyPalette_Blitzle[];
extern const u8 gMonShinyPalette_Zebstrika[];
extern const u8 gMonShinyPalette_Roggenrola[];
extern const u8 gMonShinyPalette_Boldore[];
extern const u8 gMonShinyPalette_Gigalith[];
extern const u8 gMonShinyPalette_Woobat[];
extern const u8 gMonShinyPalette_Swoobat[];
extern const u8 gMonShinyPalette_Drilbur[];
extern const u8 gMonShinyPalette_Excadrill[];
extern const u8 gMonShinyPalette_Audino[];
extern const u8 gMonShinyPalette_Timburr[];
extern const u8 gMonShinyPalette_Gurdurr[];
extern const u8 gMonShinyPalette_Conkeldurr[];
extern const u8 gMonShinyPalette_Tympole[];
extern const u8 gMonShinyPalette_Palpitoad[];
extern const u8 gMonShinyPalette_Seismitoad[];
extern const u8 gMonShinyPalette_Throh[];
extern const u8 gMonShinyPalette_Sawk[];
extern const u8 gMonShinyPalette_Sewaddle[];
extern const u8 gMonShinyPalette_Swadloon[];
extern const u8 gMonShinyPalette_Leavanny[];
extern const u8 gMonShinyPalette_Venipede[];
extern const u8 gMonShinyPalette_Whirlipede[];
extern const u8 gMonShinyPalette_Scolipede[];
extern const u8 gMonShinyPalette_Cottonee[];
extern const u8 gMonShinyPalette_Whimsicott[];
extern const u8 gMonShinyPalette_Petilil[];
extern const u8 gMonShinyPalette_Lilligant[];
extern const u8 gMonShinyPalette_Basculin[];
extern const u8 gMonShinyPalette_Sandile[];
extern const u8 gMonShinyPalette_Krokorok[];
extern const u8 gMonShinyPalette_Krookodile[];
extern const u8 gMonShinyPalette_Darumaka[];
extern const u8 gMonShinyPalette_Darmanitan[];
extern const u8 gMonShinyPalette_Maractus[];
extern const u8 gMonShinyPalette_Dwebble[];
extern const u8 gMonShinyPalette_Crustle[];
extern const u8 gMonShinyPalette_Scraggy[];
extern const u8 gMonShinyPalette_Scrafty[];
extern const u8 gMonShinyPalette_Sigilyph[];
extern const u8 gMonShinyPalette_Yamask[];
extern const u8 gMonShinyPalette_Cofagrigus[];
extern const u8 gMonShinyPalette_Tirtouga[];
extern const u8 gMonShinyPalette_Carracosta[];
extern const u8 gMonShinyPalette_Archen[];
extern const u8 gMonShinyPalette_Archeops[];
extern const u8 gMonShinyPalette_Trubbish[];
extern const u8 gMonShinyPalette_Garbodor[];
extern const u8 gMonShinyPalette_Zorua[];
extern const u8 gMonShinyPalette_Zoroark[];
extern const u8 gMonShinyPalette_Minccino[];
extern const u8 gMonShinyPalette_Cinccino[];
extern const u8 gMonShinyPalette_Gothita[];
extern const u8 gMonShinyPalette_Gothorita[];
extern const u8 gMonShinyPalette_Gothitelle[];
extern const u8 gMonShinyPalette_Solosis[];
extern const u8 gMonShinyPalette_Duosion[];
extern const u8 gMonShinyPalette_Reuniclus[];
extern const u8 gMonShinyPalette_Ducklett[];
extern const u8 gMonShinyPalette_Swanna[];
extern const u8 gMonShinyPalette_Vanillite[];
extern const u8 gMonShinyPalette_Vanillish[];
extern const u8 gMonShinyPalette_Vanilluxe[];
extern const u8 gMonShinyPalette_Deerling[];
extern const u8 gMonShinyPalette_Sawsbuck[];
extern const u8 gMonShinyPalette_Emolga[];
extern const u8 gMonShinyPalette_Karrablast[];
extern const u8 gMonShinyPalette_Escavalier[];
extern const u8 gMonShinyPalette_Foongus[];
extern const u8 gMonShinyPalette_Amoonguss[];
extern const u8 gMonShinyPalette_Frillish[];
extern const u8 gMonShinyPalette_Jellicent[];
extern const u8 gMonShinyPalette_Alomomola[];
extern const u8 gMonShinyPalette_Joltik[];
extern const u8 gMonShinyPalette_Galvantula[];
extern const u8 gMonShinyPalette_Ferroseed[];
extern const u8 gMonShinyPalette_Ferrothorn[];
extern const u8 gMonShinyPalette_Klink[];
extern const u8 gMonShinyPalette_Klang[];
extern const u8 gMonShinyPalette_Klinklang[];
extern const u8 gMonShinyPalette_Tynamo[];
extern const u8 gMonShinyPalette_Eelektrik[];
extern const u8 gMonShinyPalette_Eelektross[];
extern const u8 gMonShinyPalette_Elgyem[];
extern const u8 gMonShinyPalette_Beheeyem[];
extern const u8 gMonShinyPalette_Litwick[];
extern const u8 gMonShinyPalette_Lampent[];
extern const u8 gMonShinyPalette_Chandelure[];
extern const u8 gMonShinyPalette_Axew[];
extern const u8 gMonShinyPalette_Fraxure[];
extern const u8 gMonShinyPalette_Haxorus[];
extern const u8 gMonShinyPalette_Cubchoo[];
extern const u8 gMonShinyPalette_Beartic[];
extern const u8 gMonShinyPalette_Cryogonal[];
extern const u8 gMonShinyPalette_Shelmet[];
extern const u8 gMonShinyPalette_Accelgor[];
extern const u8 gMonShinyPalette_Stunfisk[];
extern const u8 gMonShinyPalette_Mienfoo[];
extern const u8 gMonShinyPalette_Mienshao[];
extern const u8 gMonShinyPalette_Druddigon[];
extern const u8 gMonShinyPalette_Golett[];
extern const u8 gMonShinyPalette_Golurk[];
extern const u8 gMonShinyPalette_Pawniard[];
extern const u8 gMonShinyPalette_Bisharp[];
extern const u8 gMonShinyPalette_Bouffalant[];
extern const u8 gMonShinyPalette_Rufflet[];
extern const u8 gMonShinyPalette_Braviary[];
extern const u8 gMonShinyPalette_Vullaby[];
extern const u8 gMonShinyPalette_Mandibuzz[];
extern const u8 gMonShinyPalette_Heatmor[];
extern const u8 gMonShinyPalette_Durant[];
extern const u8 gMonShinyPalette_Deino[];
extern const u8 gMonShinyPalette_Zweilous[];
extern const u8 gMonShinyPalette_Hydreigon[];
extern const u8 gMonShinyPalette_Larvesta[];
extern const u8 gMonShinyPalette_Volcarona[];
extern const u8 gMonShinyPalette_Cobalion[];
extern const u8 gMonShinyPalette_Terrakion[];
extern const u8 gMonShinyPalette_Virizion[];
extern const u8 gMonShinyPalette_Tornadus[];
extern const u8 gMonShinyPalette_Thundurus[];
extern const u8 gMonShinyPalette_Reshiram[];
extern const u8 gMonShinyPalette_Zekrom[];
extern const u8 gMonShinyPalette_Landorus[];
extern const u8 gMonShinyPalette_Kyurem[];
extern const u8 gMonShinyPalette_Keldeo[];
extern const u8 gMonShinyPalette_Meloetta[];
extern const u8 gMonShinyPalette_Genesect[];
extern const u8 gMonShinyPalette_Chespin[];
extern const u8 gMonShinyPalette_Quilladin[];
extern const u8 gMonShinyPalette_Chesnaught[];
extern const u8 gMonShinyPalette_Fennekin[];
extern const u8 gMonShinyPalette_Braixen[];
extern const u8 gMonShinyPalette_Delphox[];
extern const u8 gMonShinyPalette_Froakie[];
extern const u8 gMonShinyPalette_Frogadier[];
extern const u8 gMonShinyPalette_Greninja[];
extern const u8 gMonShinyPalette_Bunnelby[];
extern const u8 gMonShinyPalette_Diggersby[];
extern const u8 gMonShinyPalette_Fletchling[];
extern const u8 gMonShinyPalette_Fletchinder[];
extern const u8 gMonShinyPalette_Talonflame[];
extern const u8 gMonShinyPalette_Scatterbug[];
extern const u8 gMonShinyPalette_Spewpa[];
extern const u8 gMonShinyPalette_Vivillon[];
extern const u8 gMonShinyPalette_Litleo[];
extern const u8 gMonShinyPalette_Pyroar[];
extern const u8 gMonShinyPalette_Flabebe[];
extern const u8 gMonShinyPalette_Floette[];
extern const u8 gMonShinyPalette_Florges[];
extern const u8 gMonShinyPalette_Skiddo[];
extern const u8 gMonShinyPalette_Gogoat[];
extern const u8 gMonShinyPalette_Pancham[];
extern const u8 gMonShinyPalette_Pangoro[];
extern const u8 gMonShinyPalette_Furfrou[];
extern const u8 gMonShinyPalette_Espurr[];
extern const u8 gMonShinyPalette_MeowsticMale[];
extern const u8 gMonShinyPalette_MeowsticFemale[];
extern const u8 gMonShinyPalette_Honedge[];
extern const u8 gMonShinyPalette_Doublade[];
extern const u8 gMonShinyPalette_Aegislash[];
extern const u8 gMonShinyPalette_Spritzee[];
extern const u8 gMonShinyPalette_Aromatisse[];
extern const u8 gMonShinyPalette_Swirlix[];
extern const u8 gMonShinyPalette_Slurpuff[];
extern const u8 gMonShinyPalette_Inkay[];
extern const u8 gMonShinyPalette_Malamar[];
extern const u8 gMonShinyPalette_Binacle[];
extern const u8 gMonShinyPalette_Barbaracle[];
extern const u8 gMonShinyPalette_Skrelp[];
extern const u8 gMonShinyPalette_Dragalge[];
extern const u8 gMonShinyPalette_Clauncher[];
extern const u8 gMonShinyPalette_Clawitzer[];
extern const u8 gMonShinyPalette_Helioptile[];
extern const u8 gMonShinyPalette_Heliolisk[];
extern const u8 gMonShinyPalette_Tyrunt[];
extern const u8 gMonShinyPalette_Tyrantrum[];
extern const u8 gMonShinyPalette_Amaura[];
extern const u8 gMonShinyPalette_Aurorus[];
extern const u8 gMonShinyPalette_Sylveon[];
extern const u8 gMonShinyPalette_Hawlucha[];
extern const u8 gMonShinyPalette_Dedenne[];
extern const u8 gMonShinyPalette_Carbink[];
extern const u8 gMonShinyPalette_Goomy[];
extern const u8 gMonShinyPalette_Sliggoo[];
extern const u8 gMonShinyPalette_Goodra[];
extern const u8 gMonShinyPalette_Klefki[];
extern const u8 gMonShinyPalette_Phantump[];
extern const u8 gMonShinyPalette_Trevenant[];
extern const u8 gMonShinyPalette_Pumpkaboo[];
extern const u8 gMonShinyPalette_Gourgeist[];
extern const u8 gMonShinyPalette_Bergmite[];
extern const u8 gMonShinyPalette_Avalugg[];
extern const u8 gMonShinyPalette_Noibat[];
extern const u8 gMonShinyPalette_Noivern[];
extern const u8 gMonShinyPalette_Xerneas[];
extern const u8 gMonShinyPalette_Yveltal[];
extern const u8 gMonShinyPalette_Zygarde[];
extern const u8 gMonShinyPalette_Diancie[];
extern const u8 gMonShinyPalette_Hoopa[];
extern const u8 gMonShinyPalette_Volcanion[];
extern const u8 gMonShinyPalette_Rowlet[];
extern const u8 gMonShinyPalette_Dartrix[];
extern const u8 gMonShinyPalette_Decidueye[];
extern const u8 gMonShinyPalette_Litten[];
extern const u8 gMonShinyPalette_Torracat[];
extern const u8 gMonShinyPalette_Incineroar[];
extern const u8 gMonShinyPalette_Popplio[];
extern const u8 gMonShinyPalette_Brionne[];
extern const u8 gMonShinyPalette_Primarina[];
extern const u8 gMonShinyPalette_Pikipek[];
extern const u8 gMonShinyPalette_Trumbeak[];
extern const u8 gMonShinyPalette_Toucannon[];
extern const u8 gMonShinyPalette_Yungoos[];
extern const u8 gMonShinyPalette_Gumshoos[];
extern const u8 gMonShinyPalette_Grubbin[];
extern const u8 gMonShinyPalette_Charjabug[];
extern const u8 gMonShinyPalette_Vikavolt[];
extern const u8 gMonShinyPalette_Crabrawler[];
extern const u8 gMonShinyPalette_Crabominable[];
extern const u8 gMonShinyPalette_Oricorio[];
extern const u8 gMonShinyPalette_Cutiefly[];
extern const u8 gMonShinyPalette_Ribombee[];
extern const u8 gMonShinyPalette_Rockruff[];
extern const u8 gMonShinyPalette_Lycanroc[];
extern const u8 gMonShinyPalette_Wishiwashi[];
extern const u8 gMonShinyPalette_Mareanie[];
extern const u8 gMonShinyPalette_Toxapex[];
extern const u8 gMonShinyPalette_Mudbray[];
extern const u8 gMonShinyPalette_Mudsdale[];
extern const u8 gMonShinyPalette_Dewpider[];
extern const u8 gMonShinyPalette_Araquanid[];
extern const u8 gMonShinyPalette_Fomantis[];
extern const u8 gMonShinyPalette_Lurantis[];
extern const u8 gMonShinyPalette_Morelull[];
extern const u8 gMonShinyPalette_Shiinotic[];
extern const u8 gMonShinyPalette_Salandit[];
extern const u8 gMonShinyPalette_Salazzle[];
extern const u8 gMonShinyPalette_Stufful[];
extern const u8 gMonShinyPalette_Bewear[];
extern const u8 gMonShinyPalette_Bounsweet[];
extern const u8 gMonShinyPalette_Steenee[];
extern const u8 gMonShinyPalette_Tsareena[];
extern const u8 gMonShinyPalette_Comfey[];
extern const u8 gMonShinyPalette_Oranguru[];
extern const u8 gMonShinyPalette_Passimian[];
extern const u8 gMonShinyPalette_Wimpod[];
extern const u8 gMonShinyPalette_Golisopod[];
extern const u8 gMonShinyPalette_Sandygast[];
extern const u8 gMonShinyPalette_Palossand[];
extern const u8 gMonShinyPalette_Pyukumuku[];
extern const u8 gMonShinyPalette_Type_null[];
extern const u8 gMonShinyPalette_Silvally[];
extern const u8 gMonShinyPalette_Minior[];
extern const u8 gMonShinyPalette_Komala[];
extern const u8 gMonShinyPalette_Turtonator[];
extern const u8 gMonShinyPalette_Togedemaru[];
extern const u8 gMonShinyPalette_Mimikyu[];
extern const u8 gMonShinyPalette_Bruxish[];
extern const u8 gMonShinyPalette_Drampa[];
extern const u8 gMonShinyPalette_Dhelmise[];
extern const u8 gMonShinyPalette_Jangmo_o[];
extern const u8 gMonShinyPalette_Hakamo_o[];
extern const u8 gMonShinyPalette_Kommo_o[];
extern const u8 gMonShinyPalette_Tapu_koko[];
extern const u8 gMonShinyPalette_Tapu_lele[];
extern const u8 gMonShinyPalette_Tapu_bulu[];
extern const u8 gMonShinyPalette_Tapu_fini[];
extern const u8 gMonShinyPalette_Cosmog[];
extern const u8 gMonShinyPalette_Cosmoem[];
extern const u8 gMonShinyPalette_Solgaleo[];
extern const u8 gMonShinyPalette_Lunala[];
extern const u8 gMonShinyPalette_Nihilego[];
extern const u8 gMonShinyPalette_Buzzwole[];
extern const u8 gMonShinyPalette_Pheromosa[];
extern const u8 gMonShinyPalette_Xurkitree[];
extern const u8 gMonShinyPalette_Celesteela[];
extern const u8 gMonShinyPalette_Kartana[];
extern const u8 gMonShinyPalette_Guzzlord[];
extern const u8 gMonShinyPalette_Necrozma[];
extern const u8 gMonShinyPalette_Magearna[];
extern const u8 gMonShinyPalette_Marshadow[];
extern const u8 gMonShinyPalette_Poipole[];
extern const u8 gMonShinyPalette_Naganadel[];
extern const u8 gMonShinyPalette_Stakataka[];
extern const u8 gMonShinyPalette_Blacephalon[];
extern const u8 gMonShinyPalette_Zeraora[];

extern const u8 gMonFrontPic_MegaVenusaur[];
extern const u8 gMonBackPic_MegaVenusaur[];
extern const u8 gMonPalette_MegaVenusaur[];
extern const u8 gMonShinyPalette_MegaVenusaur[];
extern const u8 gMonFrontPic_MegaCharizardX[];
extern const u8 gMonBackPic_MegaCharizardX[];
extern const u8 gMonPalette_MegaCharizardX[];
extern const u8 gMonShinyPalette_MegaCharizardX[];
extern const u8 gMonFrontPic_MegaCharizardY[];
extern const u8 gMonBackPic_MegaCharizardY[];
extern const u8 gMonPalette_MegaCharizardY[];
extern const u8 gMonShinyPalette_MegaCharizardY[];
extern const u8 gMonFrontPic_MegaBlastoise[];
extern const u8 gMonBackPic_MegaBlastoise[];
extern const u8 gMonPalette_MegaBlastoise[];
extern const u8 gMonShinyPalette_MegaBlastoise[];
extern const u8 gMonFrontPic_MegaBeedrill[];
extern const u8 gMonBackPic_MegaBeedrill[];
extern const u8 gMonPalette_MegaBeedrill[];
extern const u8 gMonShinyPalette_MegaBeedrill[];
extern const u8 gMonFrontPic_MegaPidgeot[];
extern const u8 gMonBackPic_MegaPidgeot[];
extern const u8 gMonPalette_MegaPidgeot[];
extern const u8 gMonShinyPalette_MegaPidgeot[];
extern const u8 gMonFrontPic_MegaAlakazam[];
extern const u8 gMonBackPic_MegaAlakazam[];
extern const u8 gMonPalette_MegaAlakazam[];
extern const u8 gMonShinyPalette_MegaAlakazam[];
extern const u8 gMonFrontPic_MegaSlowbro[];
extern const u8 gMonBackPic_MegaSlowbro[];
extern const u8 gMonPalette_MegaSlowbro[];
extern const u8 gMonShinyPalette_MegaSlowbro[];
extern const u8 gMonFrontPic_MegaGengar[];
extern const u8 gMonBackPic_MegaGengar[];
extern const u8 gMonPalette_MegaGengar[];
extern const u8 gMonShinyPalette_MegaGengar[];
extern const u8 gMonFrontPic_MegaKangaskhan[];
extern const u8 gMonBackPic_MegaKangaskhan[];
extern const u8 gMonPalette_MegaKangaskhan[];
extern const u8 gMonShinyPalette_MegaKangaskhan[];
extern const u8 gMonFrontPic_MegaPinsir[];
extern const u8 gMonBackPic_MegaPinsir[];
extern const u8 gMonPalette_MegaPinsir[];
extern const u8 gMonShinyPalette_MegaPinsir[];
extern const u8 gMonFrontPic_MegaGyarados[];
extern const u8 gMonBackPic_MegaGyarados[];
extern const u8 gMonPalette_MegaGyarados[];
extern const u8 gMonShinyPalette_MegaGyarados[];
extern const u8 gMonFrontPic_MegaAerodactyl[];
extern const u8 gMonBackPic_MegaAerodactyl[];
extern const u8 gMonPalette_MegaAerodactyl[];
extern const u8 gMonShinyPalette_MegaAerodactyl[];
extern const u8 gMonFrontPic_MegaMewtwoX[];
extern const u8 gMonBackPic_MegaMewtwoX[];
extern const u8 gMonPalette_MegaMewtwoX[];
extern const u8 gMonShinyPalette_MegaMewtwoX[];
extern const u8 gMonFrontPic_MegaMewtwoY[];
extern const u8 gMonBackPic_MegaMewtwoY[];
extern const u8 gMonPalette_MegaMewtwoY[];
extern const u8 gMonShinyPalette_MegaMewtwoY[];
extern const u8 gMonFrontPic_MegaAmpharos[];
extern const u8 gMonBackPic_MegaAmpharos[];
extern const u8 gMonPalette_MegaAmpharos[];
extern const u8 gMonShinyPalette_MegaAmpharos[];
extern const u8 gMonFrontPic_MegaSteelix[];
extern const u8 gMonBackPic_MegaSteelix[];
extern const u8 gMonPalette_MegaSteelix[];
extern const u8 gMonShinyPalette_MegaSteelix[];
extern const u8 gMonFrontPic_MegaScizor[];
extern const u8 gMonBackPic_MegaScizor[];
extern const u8 gMonPalette_MegaScizor[];
extern const u8 gMonShinyPalette_MegaScizor[];
extern const u8 gMonFrontPic_MegaHeracross[];
extern const u8 gMonBackPic_MegaHeracross[];
extern const u8 gMonPalette_MegaHeracross[];
extern const u8 gMonShinyPalette_MegaHeracross[];
extern const u8 gMonFrontPic_MegaHoundoom[];
extern const u8 gMonBackPic_MegaHoundoom[];
extern const u8 gMonPalette_MegaHoundoom[];
extern const u8 gMonShinyPalette_MegaHoundoom[];
extern const u8 gMonFrontPic_MegaTyranitar[];
extern const u8 gMonBackPic_MegaTyranitar[];
extern const u8 gMonPalette_MegaTyranitar[];
extern const u8 gMonShinyPalette_MegaTyranitar[];
extern const u8 gMonFrontPic_MegaSceptile[];
extern const u8 gMonBackPic_MegaSceptile[];
extern const u8 gMonPalette_MegaSceptile[];
extern const u8 gMonShinyPalette_MegaSceptile[];
extern const u8 gMonFrontPic_MegaBlaziken[];
extern const u8 gMonBackPic_MegaBlaziken[];
extern const u8 gMonPalette_MegaBlaziken[];
extern const u8 gMonShinyPalette_MegaBlaziken[];
extern const u8 gMonFrontPic_MegaSwampert[];
extern const u8 gMonBackPic_MegaSwampert[];
extern const u8 gMonPalette_MegaSwampert[];
extern const u8 gMonShinyPalette_MegaSwampert[];
extern const u8 gMonFrontPic_MegaGardevoir[];
extern const u8 gMonBackPic_MegaGardevoir[];
extern const u8 gMonPalette_MegaGardevoir[];
extern const u8 gMonShinyPalette_MegaGardevoir[];
extern const u8 gMonFrontPic_MegaSableye[];
extern const u8 gMonBackPic_MegaSableye[];
extern const u8 gMonPalette_MegaSableye[];
extern const u8 gMonShinyPalette_MegaSableye[];
extern const u8 gMonFrontPic_MegaMawile[];
extern const u8 gMonBackPic_MegaMawile[];
extern const u8 gMonPalette_MegaMawile[];
extern const u8 gMonShinyPalette_MegaMawile[];
extern const u8 gMonFrontPic_MegaAggron[];
extern const u8 gMonBackPic_MegaAggron[];
extern const u8 gMonPalette_MegaAggron[];
extern const u8 gMonShinyPalette_MegaAggron[];
extern const u8 gMonFrontPic_MegaMedicham[];
extern const u8 gMonBackPic_MegaMedicham[];
extern const u8 gMonPalette_MegaMedicham[];
extern const u8 gMonShinyPalette_MegaMedicham[];
extern const u8 gMonFrontPic_MegaManectric[];
extern const u8 gMonBackPic_MegaManectric[];
extern const u8 gMonPalette_MegaManectric[];
extern const u8 gMonShinyPalette_MegaManectric[];
extern const u8 gMonFrontPic_MegaSharpedo[];
extern const u8 gMonBackPic_MegaSharpedo[];
extern const u8 gMonPalette_MegaSharpedo[];
extern const u8 gMonShinyPalette_MegaSharpedo[];
extern const u8 gMonFrontPic_MegaCamerupt[];
extern const u8 gMonBackPic_MegaCamerupt[];
extern const u8 gMonPalette_MegaCamerupt[];
extern const u8 gMonShinyPalette_MegaCamerupt[];
extern const u8 gMonFrontPic_MegaAltaria[];
extern const u8 gMonBackPic_MegaAltaria[];
extern const u8 gMonPalette_MegaAltaria[];
extern const u8 gMonShinyPalette_MegaAltaria[];
extern const u8 gMonFrontPic_MegaBanette[];
extern const u8 gMonBackPic_MegaBanette[];
extern const u8 gMonPalette_MegaBanette[];
extern const u8 gMonShinyPalette_MegaBanette[];
extern const u8 gMonFrontPic_MegaAbsol[];
extern const u8 gMonBackPic_MegaAbsol[];
extern const u8 gMonPalette_MegaAbsol[];
extern const u8 gMonShinyPalette_MegaAbsol[];
extern const u8 gMonFrontPic_MegaGlalie[];
extern const u8 gMonBackPic_MegaGlalie[];
extern const u8 gMonPalette_MegaGlalie[];
extern const u8 gMonShinyPalette_MegaGlalie[];
extern const u8 gMonFrontPic_MegaSalamence[];
extern const u8 gMonBackPic_MegaSalamence[];
extern const u8 gMonPalette_MegaSalamence[];
extern const u8 gMonShinyPalette_MegaSalamence[];
extern const u8 gMonFrontPic_MegaMetagross[];
extern const u8 gMonBackPic_MegaMetagross[];
extern const u8 gMonPalette_MegaMetagross[];
extern const u8 gMonShinyPalette_MegaMetagross[];
extern const u8 gMonFrontPic_MegaLatias[];
extern const u8 gMonBackPic_MegaLatias[];
extern const u8 gMonPalette_MegaLatias[];
extern const u8 gMonShinyPalette_MegaLatias[];
extern const u8 gMonFrontPic_MegaLatios[];
extern const u8 gMonBackPic_MegaLatios[];
extern const u8 gMonPalette_MegaLatios[];
extern const u8 gMonShinyPalette_MegaLatios[];
extern const u8 gMonFrontPic_PrimalKyogre[];
extern const u8 gMonBackPic_PrimalKyogre[];
extern const u8 gMonPalette_PrimalKyogre[];
extern const u8 gMonShinyPalette_PrimalKyogre[];
extern const u8 gMonFrontPic_PrimalGroudon[];
extern const u8 gMonBackPic_PrimalGroudon[];
extern const u8 gMonPalette_PrimalGroudon[];
extern const u8 gMonShinyPalette_PrimalGroudon[];
extern const u8 gMonFrontPic_MegaRayquaza[];
extern const u8 gMonBackPic_MegaRayquaza[];
extern const u8 gMonPalette_MegaRayquaza[];
extern const u8 gMonShinyPalette_MegaRayquaza[];
extern const u8 gMonFrontPic_MegaLopunny[];
extern const u8 gMonBackPic_MegaLopunny[];
extern const u8 gMonPalette_MegaLopunny[];
extern const u8 gMonShinyPalette_MegaLopunny[];
extern const u8 gMonFrontPic_MegaGarchomp[];
extern const u8 gMonBackPic_MegaGarchomp[];
extern const u8 gMonPalette_MegaGarchomp[];
extern const u8 gMonShinyPalette_MegaGarchomp[];
extern const u8 gMonFrontPic_MegaLucario[];
extern const u8 gMonBackPic_MegaLucario[];
extern const u8 gMonPalette_MegaLucario[];
extern const u8 gMonShinyPalette_MegaLucario[];
extern const u8 gMonFrontPic_MegaAbomasnow[];
extern const u8 gMonBackPic_MegaAbomasnow[];
extern const u8 gMonPalette_MegaAbomasnow[];
extern const u8 gMonShinyPalette_MegaAbomasnow[];
extern const u8 gMonFrontPic_MegaGallade[];
extern const u8 gMonBackPic_MegaGallade[];
extern const u8 gMonPalette_MegaGallade[];
extern const u8 gMonShinyPalette_MegaGallade[];
extern const u8 gMonFrontPic_MegaAudino[];
extern const u8 gMonBackPic_MegaAudino[];
extern const u8 gMonPalette_MegaAudino[];
extern const u8 gMonShinyPalette_MegaAudino[];
extern const u8 gMonFrontPic_MegaDiancie[];
extern const u8 gMonBackPic_MegaDiancie[];
extern const u8 gMonPalette_MegaDiancie[];
extern const u8 gMonShinyPalette_MegaDiancie[];
...
extern const u8 gBattleAnimSpriteSheet_WhiteStreak[];
...
extern const u8 gBattleAnimSpriteSheet_PsychoCut[];
extern const u8 gBattleAnimSpriteSheet_StoneEdge[];
extern const u8 gBattleAnimSpriteSheet_StealthRock[];
extern const u8 gBattleAnimSpriteSheet_WoodHammer[];
extern const u8 gBattleAnimSpriteSheet_Bee[];
...
extern const u8 gBattleAnimSpritePalette_Acupressure[];
extern const u8 gBattleAnimSpritePalette_WhiteStreak[];
...
extern const u8 gBattleAnimSpritePalette_PsychoCut[];
extern const u8 gBattleAnimSpritePalette_StoneEdge[];
extern const u8 gBattleAnimSpritePalette_StealthRock[];
extern const u8 gBattleAnimSpritePalette_WoodHammer[];
extern const u8 gBattleAnimSpritePalette_Bee[];
