...
/*
 *	note that "Foe" being changed to "The opposing" likely causes some texts to go out of the text box.  for this reason, i decided to leave it be
 */
...
enum
{
    ...
    BATTLE_TEXT_OwnItemCausedDamage,
...
const u8 BattleText_BadlyPoisoned[] = _("{STRING 14} was badly\npoisoned!");
...
const u8 BattleText_InfatuatedPokeItem[] = _("{ATTACKING_MON}'s {STRING 19}\ninfatuated {DEFENDING_MON}!");
const u8 BattleText_InfatuatedPokeItem2[] = _("{DEFENDING_MON}'s {STRING 19}\ninfatuated {ATTACKING_MON}!");
...
const u8 BattleText_GotAwaySafely[] = _("{PLAY_SE SE_NIGERU}You got away safely!\p");
...
const u8 BattleText_PlayerDefeatedTrainer[] = _("You defeated\n{STRING 29}!");
const u8 BattleText_PlayerDefeatedTrainers[] = _("You defeated {STRING 30}\nand {STRING 29}!");
const u8 BattleText_PlayerLostTrainer[] = _("You lost against\n{STRING 29}!");
const u8 BattleText_PlayerLostTrainers[] = _("You lost to {STRING 30}\nand {STRING 29}!");
const u8 BattleText_PlayerTiedTrainer[] = _("You tied against\n{STRING 29}!");
const u8 BattleText_PlayerTiedTrainers[] = _("You tied against {STRING 30}\nand {STRING 29}!");
...
const u8 BattleText_WildAppeared1[] = _("A wild {STRING 3} appeared!\p");
const u8 BattleText_WildAppeared2[] = _("A wild {STRING 3} appeared!\p");
const u8 BattleText_WildAppeared3[] = _("A wild {STRING 3} appeared!{PAUSE 127}");
const u8 BattleText_WildDoubleAppeared[] = _("Wild {STRING 5} and\n{STRING 3} appeared!\p");
const u8 BattleText_SingleWantToBattle1[] = _("You are challenged by\n{STRING 25} {STRING 26}!\p");
const u8 BattleText_SingleWantToBattle2[] = _("You are challenged by\n{STRING 29}!");
const u8 BattleText_DoubleWantToBattle[] = _("You are challenged by\n{STRING 29} and {STRING 30}!");
...
const u8 BattleText_Wild[] = _("The wild ");
...
const u8 BattleStatText_SpAtk[] = _("Sp. Atk"); // might change these to unabbreviated
...
const u8 BattleText_Taunt[] = _("taunt");
const u8 BattleText_Encore[] = _("encore");
const u8 BattleText_Torment[] = _("torment");
const u8 BattleText_Disable[] = _("disability");
const u8 BattleText_Many[] = _("many"); // used in the case of the mental herb if multiple statuses are cured
