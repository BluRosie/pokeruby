...
const u8 *const gMoveDescriptions[] =
{
    ...
    [MOVE_GLACIATE - 1] = sNotDoneYetDescription,
    ...
    [MOVE_PARABOLIC_CHARGE - 1] = sNotDoneYetDescription,
    ...
    [MOVE_HOLD_BACK - 1] = sNotDoneYetDescription,
    ...
    [MOVE_LANDS_WRATH - 1] = sNotDoneYetDescription,
