...
/*
BIGASS FUCK THIS GAME MAN
alright so here we got some high-quality bullshit
structure, each item varies:
[0]:
[1]:
[2]:
[3]:
[4]: bitmask: | | | | | | | | | | | | | IS_HEALING_ITEM | | 
[5]:
every item has everything above this
[6]: amount of hp/pp healed/stat stage augmented, FE is half hp, FF is full hp, 7F is full pp, 253 is rare candy
*/

#define HEALING_ITEM 4
...
const u8 *const gItemEffectTable[] = // OH SHIT FUCK
{
    gItemEffect_Potion,
