...
const struct BattleMove gBattleMoves[NUM_MOVES] =
{
    [MOVE_NONE] =
    {
        .effect = EFFECT_HIT,
    ...
    [MOVE_SUNSTEEL_STRIKE] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGSROCK_AFFECTED | FLAG_ABILITY_IGNORED,
        .split = SPLIT_PHYSICAL,
    },
    ...
    [MOVE_MOONGEIST_BEAM] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGSROCK_AFFECTED | FLAG_ABILITY_IGNORED,
        .split = SPLIT_SPECIAL,
    },
