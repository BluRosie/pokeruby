static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 27, 15},
    ...
    {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 8, 6},
    {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 18, 13},
    {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 17, 6},
